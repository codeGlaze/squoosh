self.nextDefineUri = location.origin + '/c/initial-app-6fa33816.js';
if (!self.define) {
  let e = {};
  const t = (t, n) => (
    (t = t.startsWith(location.origin) ? t : new URL(t + '.js', n).href),
    e[t] ||
      new Promise((e) => {
        if ('document' in self) {
  ...
  self.define = (n, i) => {
    ...
    let s = {};
    const r = (e) => t(e, o),
      a = { module: { uri: o }, exports: s, require: r };
    e[o] = Promise.resolve()
      .then(() => Promise.all(n.map((e) => a[e] || r(e))))
      .then((e) => (i(...e), s));
  };
}
define(['require', 'exports'], function (e, t) {
  ...
  function g(e) {
    ((!e.__d && (e.__d = !0) && i.push(e) && !b.__r++) ||
      s !== n.debounceRendering) &&
      ((s = n.debounceRendering) || o)(b);
  }
  function b() {
  ...
  function y(e, t, n, i, o, s, r, c, _, p) {
    var f,
      ...
      E = x.length;
    for (
      _ == a && (_ = null != r ? r[0] : E ? m(i, 0) : null), n.__k = [], f = 0;
      f < t.length;
      f++
    )
      if (
        ...
        (b = n.__k[f] =
          null == (b = t[f]) || 'boolean' == typeof b
            ...
            ? h(null, b, null, null, b)
            : Array.isArray(b)
            ? h(u, { children: b }, null, null, null)
            : null != b.__e || null != b.__c
            ? h(b.type, b.props, b.key, null, b.__v)
            : b)
      ) {
        if (
          ((b.__ = n),
          (b.__b = n.__b + 1),
          null === (g = x[f]) || (g && b.key == g.key && b.type === g.type))
        )
          x[f] = void 0;
        else
          for (v = 0; v < E; v++) {
            if ((g = x[v]) && b.key == g.key && b.type === g.type) {
              x[v] = void 0;
              break;
            }
            g = null;
          }
        (y = z(e, b, (g = g || a), o, s, r, c, _, p)),
          (v = b.ref) &&
            g.ref != v &&
            (k || (k = []),
            g.ref && k.push(g.ref, null, b),
            k.push(v, b.__c || y, b)),
          null != y
            ? (null == D && (D = y),
              (_ = w(e, b, g, x, r, y, _)),
              p || 'option' != n.type
                ? 'function' == typeof n.type && (n.__d = _)
                : (e.value = ''))
            : _ && g.__e == _ && _.parentNode != e && (_ = m(g));
      }
    if (((n.__e = D), null != r && 'function' != typeof n.type))
      for (f = r.length; f--; ) null != r[f] && d(r[f]);
    for (f = E; f--; ) null != x[f] && B(x[f], x[f]);
    if (k) for (f = 0; f < k.length; f++) S(k[f], k[++f], k[++f]);
  }
  function w(e, t, n, i, o, s, r) {
    var a, l, c;
    if (void 0 !== t.__d) (a = t.__d), (t.__d = void 0);
    else if (o == n || s != r || null == s.parentNode)
      e: if (null == r || r.parentNode !== e) e.appendChild(s), (a = null);
      else {
        for (l = r, c = 0; (l = l.nextSibling) && c < i.length; c += 2)
          if (l == s) break e;
  ...
  function D(e, t, n) {
    '-' === t[0]
      ? e.setProperty(t, n)
      : (e[t] =
          null == n ? '' : 'number' != typeof n || c.test(t) ? n : n + 'px');
  }
    ...
    if ((o && 'className' == t && (t = 'class'), 'style' === t))
      ...
      'o' === t[0] && 'n' === t[1]
        ? ((s = t !== (t = t.replace(/Capture$/, ''))),
          ...
          (e.l[t + s] = n),
          (a = s ? E : x),
          n ? i || e.addEventListener(t, a, s) : e.removeEventListener(t, a, s))
        : 'list' !== t &&
          'tagName' !== t &&
          'form' !== t &&
          'type' !== t &&
    ...
    for (i = 0; i < e.__k.length; i++)
      (o = e.__k[i]) &&
        ...
        o.__e &&
          ...
          (t = w(n, o, o, e.__k, null, o.__e, t)),
          'function' == typeof e.type && (e.__d = t)));
  }
  function z(e, t, i, o, s, r, a, l, c) {
    var d,
      p,
      h,
      m,
    ...
    null != i.__h &&
      ((c = i.__h), (l = t.__e = i.__e), (t.__h = null), (r = [l])),
      (d = n.__b) && d(t);
    try {
      e: if ('function' == typeof E) {
        if (
          ((w = t.props),
          (D = (d = E.contextType) && o[d.__c]),
          (k = d ? (D ? D.props.value : d.__) : o),
          i.__c
          ...
          null != E.getDerivedStateFromProps &&
            ...
            _(p.__s, E.getDerivedStateFromProps(w, p.__s))),
          (m = p.props),
          (v = p.state),
          h)
        )
          ...
          if (
            (null == E.getDerivedStateFromProps &&
              ...
              p.componentWillReceiveProps(w, k),
            (!p.__e &&
              null != p.shouldComponentUpdate &&
              !1 === p.shouldComponentUpdate(w, p.__s, k)) ||
              t.__v === i.__v)
          ) {
            (p.props = w),
              (p.state = p.__s),
          ...
          null != p.componentWillUpdate && p.componentWillUpdate(w, p.__s, k),
        ...
        (p.context = k),
          ...
          (p.state = p.__s),
          null != p.getChildContext && (o = _(_({}, o), p.getChildContext())),
          h ||
            null == p.getSnapshotBeforeUpdate ||
            (g = p.getSnapshotBeforeUpdate(m, v)),
          (x =
            null != d && d.type == u && null == d.key ? d.props.children : d),
          y(e, Array.isArray(x) ? x : [x], t, i, o, s, r, a, l, c),
          (p.base = t.__e),
          (t.__h = null),
          p.__h.length && a.push(p),
          b && (p.__E = p.__ = null),
        ...
        null == r && t.__v === i.__v
          ...
          : (t.__e = A(i.__e, t, i, o, s, r, a, c));
      (d = n.diffed) && d(t);
    } catch (e) {
      (t.__v = null),
        (c || null != r) &&
          ((t.__e = l), (t.__h = !!c), (r[r.indexOf(l)] = null)),
        n.__e(e, t, i);
    }
    return t.__e;
  }
  ...
  function A(e, t, n, i, o, s, r, c) {
    ...
    if (((o = 'svg' === t.type || o), null != s))
      for (_ = 0; _ < s.length; _++)
        if (
          null != (d = s[_]) &&
          ((null === t.type ? 3 === d.nodeType : d.localName === t.type) ||
            e == d)
        ) {
          (e = d), (s[_] = null);
          break;
    ...
    if (null === t.type) f === m || (c && e.data === m) || (e.data = m);
      ...
      if (
        (null != s && (s = l.slice.call(e.childNodes)),
        (p = (f = n.props || a).dangerouslySetInnerHTML),
        ...
        (h || p) &&
          ((h && ((p && h.__html == p.__html) || h.__html === e.innerHTML)) ||
            (e.innerHTML = (h && h.__html) || ''));
      }
      (function (e, t, n, i, o) {
        var s;
        for (s in n)
          'children' === s || 'key' === s || s in t || k(e, s, null, n[s], i);
        for (s in t)
          (o && 'function' != typeof t[s]) ||
            'children' === s ||
            'key' === s ||
            'value' === s ||
            'checked' === s ||
        ...
        c ||
          ('value' in m &&
            void 0 !== (_ = m.value) &&
            (_ !== e.value || ('progress' === t.type && !_)) &&
            k(e, 'value', _, f.value, !1),
          'checked' in m &&
            void 0 !== (_ = m.checked) &&
            _ !== e.checked &&
            k(e, 'checked', _, f.checked, !1));
    }
    return e;
  }
  function S(e, t, i) {
  ...
  function B(e, t, i) {
    ...
    if (
      ...
      (o = e.ref) && ((o.current && o.current !== e.__e) || S(o, null, t)),
    ...
    if ((o = e.__k)) for (r = 0; r < o.length; r++) o[r] && B(o[r], t, i);
    null != s && d(s);
  }
  function L(e, t, n) {
  ...
  function q(e, t, n) {
    ...
    let o;
    if ('' === t)
      return (o = i.filter((e) => 'file' === e.kind)), n ? o : [o[0]];
    const s = t
      .toLowerCase()
      .split(',')
  ...
  class T extends HTMLElement {
    ...
    _onDragEnter(e) {
      ...
      const t = q(e.dataTransfer.items, this.accept, null !== this.multiple);
      this.classList.add(
        e.dataTransfer && e.dataTransfer.items.length && void 0 === t[0]
          ? 'drop-invalid'
          : 'drop-valid',
      );
    }
    ...
    _onDrop(e) {
      ...
      this._reset();
      const t = I(e.dataTransfer, this.accept, null !== this.multiple);
      void 0 !== t &&
        this.dispatchEvent(new U('filedrop', { action: 'drop', files: t }));
    }
    _onPaste(e) {
      if (!e.clipboardData) return;
      const t = I(e.clipboardData, this.accept, void 0 !== this.multiple);
      void 0 !== t &&
        this.dispatchEvent(new U('filedrop', { action: 'paste', files: t }));
    }
    _reset() {
      (this._dragEnterCount = 0),
    ...
    class extends Q {
      ...
      connectedCallback() {
        (this.style.display = 'none'),
          (this.innerHTML = `<div class="_spinner-container_18q42_141"><div class="_spinner-layer_18q42_150"><div class="${j} _spinner-left_18q42_123"><div class="${N}"></div></div><div class="_spinner-gap-patch_18q42_98"><div class="${N}"></div></div><div class="${j} _spinner-right_18q42_129"><div class="${N}"></div></div></div></div>`);
  ...
  const Y = '_load-img_vzxu7_46',
    W = '_top-wave_vzxu7_106',
    G = '_info_vzxu7_125',
    H = '_info-container_vzxu7_135',
    R = '_info-content_vzxu7_140',
    Z = '_info-title_vzxu7_160',
    K = '_info-caption_vzxu7_166',
    J = '_info-text-wrapper_vzxu7_183',
    $ = '_info-img-wrapper_vzxu7_199',
    X = '_info-img_vzxu7_199',
    ee = [
      [
    ...
    componentDidMount() {
      ...
      (this.observer = new IntersectionObserver(
        (n, i) => {
          for (const o of n) {
            if (!o.isIntersecting)
              return (t = !0), void (e.style.opacity = '0');
            t &&
              ((e.style.opacity = ''),
              e.animate(
  ...
  const ne = [
      {
        ...
        size: '2.8MB',
        filename: 'photo.jpg',
        url: '/c/demo-large-photo-a6b23f7b.jpg',
        iconUrl: '/c/icon-demo-large-photo-18da387a.jpg',
      },
      {
        description: 'Artwork',
        size: '2.9MB',
        filename: 'art.jpg',
        url: '/c/demo-artwork-c444f915.jpg',
        iconUrl: '/c/icon-demo-artwork-9eba1655.jpg',
      },
      {
        description: 'Device screen',
        size: '1.6MB',
        filename: 'pixel3.png',
        url: '/c/demo-device-screen-b9d088e8.png',
        iconUrl: '/c/icon-demo-device-screen-5d52d8b9.jpg',
      },
      {
        description: 'SVG icon',
        size: '13KB',
        filename: 'squoosh.svg',
        url: '/c/logo-bcc20dd5.svg',
        iconUrl: '/c/icon-demo-logo-326ed9b6.png',
      },
    ],
    ie = matchMedia('(prefers-reduced-motion: reduce)').matches
      ? void 0
      : e('./blob-anim-46f7ac2e'),
    oe = 'introInstallButton-Purple',
    se = navigator.clipboard && navigator.clipboard.read;
  class re extends f {
    constructor() {
      super(...arguments),
        (this.state = { showBlobSVG: !0 }),
        (this.installingViaButton = !1),
        (this.onFileChange = (e) => {
          const t = e.target,
            n = t.files && t.files[0];
        ...
        (this.onDemoClick = async (e, t) => {
          try {
            this.setState({ fetchingDemoIndex: e });
            const t = ne[e],
              n = await fetch(t.url).then((e) => e.blob()),
              i = new File([n], t.filename, { type: n.type });
            this.props.onFile(i);
          } catch (e) {
            this.setState({ fetchingDemoIndex: void 0 }),
              this.props.showSnack("Couldn't fetch demo image");
          }
        }),
        (this.onBeforeInstallPromptEvent = (e) => {
          e.preventDefault(), this.setState({ beforeInstallEvent: e });
          ga('send', 'event', {
        ...
        (this.onInstallClick = async (e) => {
          ...
          const { outcome: n } = await t.userChoice;
          ga('send', 'event', {
            eventCategory: 'pwa-install',
        ...
        (this.onAppInstalled = () => {
          if ((this.setState({ beforeInstallEvent: void 0 }), document.hidden))
            return;
          const e = this.installingViaButton ? oe : 'browser';
          ga('send', 'event', 'pwa-install', 'installed', e),
            (this.installingViaButton = !1);
        }),
        (this.onPasteClick = async () => {
          ...
          try {
            ...
            return void this.props.showSnack(
              'No permission to access clipboard',
            );
          }
          ...
          t
            ? this.props.onFile(new File([t], 'image.unknown'))
    ...
    render(
      {},
      { fetchingDemoIndex: e, beforeInstallEvent: t, showBlobSVG: n },
    ) {
      return p(
        'div',
        { class: '_intro_vzxu7_1 abs-fill' },
        p('input', {
          class: '_hide_vzxu7_18',
        ...
        p(
          'div',
          { class: '_main_vzxu7_22' },
          p('canvas', {
            ref: M(this, 'blobCanvas'),
            class: '_blob-canvas_vzxu7_12 abs-fill',
          }),
          p(
            'h1',
            { class: '_logo-container_vzxu7_36' },
            p('img', {
              class: '_logo_vzxu7_36',
          ...
          p(
            ...
            n &&
              p(
                'svg',
                {
                  class: '_blob-svg_vzxu7_53 abs-fill',
                    ...
                    d: e
                      .map((t, n) => {
                        ...
                        return (
                          0 === n && (o += `M${t[2]} ${t[3]}`),
                          o +
                            `C${t[4]} ${t[5]} ${e[i][0]} ${e[i][1]} ${e[i][2]} ${e[i][3]}`
                        );
                      })
                      .join(''),
                  }),
            ...
            p(
              'div',
              {
                class: '_load-img-content_vzxu7_64',
                style: { visibility: '' },
              },
              p(
                'button',
                {
                  class: '_load-btn_vzxu7_81 unbutton',
                  onClick: this.onOpenClick,
                },
                p(
                  'svg',
                  { viewBox: '0 0 24 24', class: '_load-icon_vzxu7_85' },
                  p('path', {
              ...
              p(
                'div',
                null,
                p('span', { class: '_drop-text_vzxu7_363' }, 'Drop '),
                'OR',
                ' ',
                se
                  ? p(
                      'button',
                      {
                        class: '_paste-btn_vzxu7_93 unbutton',
        ...
        p(
          'div',
          { class: '_demos-container_vzxu7_100' },
          p(
            'svg',
            { viewBox: '0 0 1920 140', class: W },
            p('path', {
          ...
          p(
            'div',
            { class: '_content-padding_vzxu7_237' },
            p(
              'p',
              { class: '_demo-title_vzxu7_297' },
              'Or ',
              p('strong', null, 'try one'),
              ' of these:',
            ),
            p(
              'ul',
              { class: '_demos_vzxu7_100' },
              ne.map((t, n) =>
                p(
                  'li',
                  null,
                  p(
                    ...
                    p(
                      'div',
                      { class: '_demo-container_vzxu7_324' },
                      p(
                        'div',
                        { class: '_demo-icon-container_vzxu7_340' },
                        p('img', {
                        ...
                        e === n &&
                          p(
                            'div',
                            { class: '_demo-loader_vzxu7_350 abs-fill' },
                            p('loading-spinner', null),
                          ),
                      ),
                      p('div', { class: '_demo-size_vzxu7_331' }, t.size),
                    ),
                  ),
                ),
              ),
        ...
        p(
          'footer',
          { class: '_footer_vzxu7_223' },
          p(
            'div',
            { class: '_footer-container_vzxu7_228' },
            p(
              'svg',
              { viewBox: '0 0 1920 79', class: W },
              p('path', {
                d: 'M0 59l64-11c64-11 192-34 320-43s256-5 384 4 256 23 384 34 256 21 384 14 256-30 320-41l64-11v94H0z',
                class: '_footer-wave_vzxu7_233',
              }),
            ),
            p(
              'div',
              { class: '_footer-padding_vzxu7_241' },
              p(
                'footer',
                { class: '_footer-items_vzxu7_245' },
                p(
                  'a',
                  {
                    class: '_footer-link_vzxu7_260',
                ...
                p(
                  ...
                  {
                    class:
                      '_footer-link-with-logo_vzxu7_265 _footer-link_vzxu7_260',
                    href: 'https://github.com/GoogleChromeLabs/squoosh',
                  },
                  p('img', {
                    src: '/c/github-logo-bc05494c.svg',
                    alt: '',
                    width: '10',
                    height: '10',
                  }),
        ...
        t &&
          p(
            'button',
            {
              class: '_install-btn_vzxu7_284 unbutton',
  ...
  const ae = '/editor',
    le = e('./Compress-d6f5ed18'),
    ce = e('./sw-bridge-6c37044f');
  function _e() {
    window.history.back();
  }
  class de extends f {
      ...
      super(),
        ...
        (this.onFileDrop = ({ files: e }) => {
          ...
          const t = Array.from(e),
            n = this.state.isEditorOpen;
          this.openEditor(),
            this.setState({ files: t, selectedIndex: 0 }),
            n && this.confirmSwap(t[0]);
        }),
        (this.onIntroPickFile = (e) => {
          this.openEditor(), this.setState({ files: [e], selectedIndex: 0 });
        }),
        (this.onEditorPickFiles = (e) => {
          0 !== e.length &&
            (this.setState({ files: e, selectedIndex: 0 }),
            1 === e.length
              ? this.confirmSwap(e[0])
              : this.showSnack(`Loaded ${e.length} images`, { timeout: 3e3 }));
        }),
        (this.showSnack = (e, t = {}) => {
        ...
        (this.onPopState = () => {
          this.setState({ isEditorOpen: location.pathname === ae });
        }),
        (this.openEditor = () => {
          ...
          (e.pathname = ae),
            ...
            this.setState({ isEditorOpen: !0 });
        }),
        le
          .then((e) => {
            this.setState({ Compress: e.default });
          })
          .catch(() => {
            this.showSnack('Failed to load app');
          }),
        ce.then(async ({ offliner: e, getSharedImage: t }) => {
    ...
    confirmSwap(e) {
      this.showSnack(`Now editing “${e.name}”`, { timeout: 3e3 });
    }
    render(
      {},
      {
      ...
      return p(
        ...
        p(
          'file-drop',
          { onfiledrop: this.onFileDrop, class: '_drop_11rsf_11' },
          s
            ? p('loading-spinner', { class: '_app-loader_11rsf_61' })
            : n
            ? i &&
              r &&
              p(i, {
          ...
          p('snack-bar', { ref: M(this, 'snackbar') }),
        ),
      );
    }
  }
  const pe = document.getElementById('app');
  !(async function () {
    !(function (e, t, i) {
      var o, s, c;
      n.__ && n.__(e, t),
        (s = (o = i === r) ? null : (i && i.__k) || t.__k),
        (e = p(u, null, [e])),
        (c = []),
        z(
          t,
  ...
  })();
  {
    const e =
      ...
      window.matchMedia('(display-mode: standalone)').matches
        ? 'standalone'
        : 'browser';
    (window.ga = window.ga || ((...e) => (ga.q = ga.q || []).push(e))),

      ...
      function (r) {
        ...
        function H(n) {
          (m = n),
            ...
            (r.HEAPU32 = P = new Uint32Array(n)),
            (r.HEAPF32 = C = new Float32Array(n)),
        ...
        r.locateFile
          ? L((q = 'avif_dec.wasm')) ||
            ((z = q), (q = r.locateFile ? r.locateFile(z, f) : f + z))
          : (q = new URL('/c/avif_dec-d634d9c0.wasm', n.uri).toString());
        var K = [];
        function X(n) {
          var r = K[n];
          return (
            r || (n >= K.length && (K.length = n + 1), (K[n] = r = k.get(n))), r
          );
        }
        function Y(n) {
          switch (n) {
        ...
        var mn = {
          toValue: function (n) {
            return (
              n || fn('Cannot use deleted val. handle = ' + n), dn[n].value
            );
          },
          toHandle: function (n) {
            switch (n) {
        ...
        function En(n, r) {
          ...
          return (
            'function' != typeof a &&
              fn('unknown function pointer with signature ' + n + ': ' + r),
            a
          );
        }
        var kn = void 0;
        ...
        !(function () {
          ...
          (cn = r.BindingError = un(Error, 'BindingError')),
          (sn = r.InternalError = un(Error, 'InternalError')),
          (r.count_emval_handles = yn),
          (r.get_first_emval = gn),
          (kn = r.UnboundTypeError = un(Error, 'UnboundTypeError'));
        var On = {
            ...
            pn(n, {
              ...
              toWireType: function (n, r) {
                if ('number' != typeof r && 'boolean' != typeof r)
                  throw new TypeError(
                    'Cannot convert "' + bn(r) + '" to ' + this.name,
                  );
                return r;
              },
              argPackAdvance: 8,
            ...
            (n = $(n)),
                  ...
                  !(function (n, r) {
                    ...
                    throw (
                      (r.forEach(function n(r) {
                        e[r] ||
                          nn[r] ||
                          (rn[r] ? rn[r].forEach(n) : (t.push(r), (e[r] = !0)));
                      }),
              ...
              (function (n, r, t) {
                function e(r) {
                  var e = t(r);
                  e.length !== n.length &&
                    ln('Mismatched type converter count');
            ...
            pn(n, {
              ...
              toWireType: function (n, t) {
                if ('number' != typeof t && 'boolean' != typeof t)
                  throw new TypeError(
                    'Cannot convert "' + bn(t) + '" to ' + this.name,
                  );
                if (t < e || t > o)
                  throw new TypeError(
                    'Passing a number "' +
            ...
            (t = $(t)),
              ...
              pn(n, {
                ...
                toWireType: function (n, e) {
                  'string' != typeof e &&
                    fn('Cannot pass non-string to C++ string type ' + t);
                  var a = i(e),
                    c = xn(4 + a + r);
                  return (
                    (P[c >> 2] = a >> u),
        ...
        !(function () {
          ...
          if (
            ...
            try {
              ...
              return (
                l('Module.instantiateWasm callback failed with error: ' + n), !1
              );
            }
          (p ||
          ...
          'function' != typeof fetch
            ...
            : fetch(q, { credentials: 'same-origin' }).then(function (r) {
                return WebAssembly.instantiateStreaming(r, n).then(
                  ...
                  function (n) {
                    return (
                      l('wasm streaming compile failed: ' + n),

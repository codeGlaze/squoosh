define(['exports', './idb-keyval-70c4f780'], function (e, t) {
  async function a(e) {
    if (e.waiting) return;
  ...
  (e.getSharedImage = function () {
    ...
    (e.offliner = async function (e) {
      ...
      if (
        (navigator.serviceWorker.addEventListener(
          ...
          async () => {
            n
              ? location.reload()
              : e('Ready to work offline', { timeout: 5e3 });
          },
        ),
        !n)
      )
      ...
      await a(i),
        'reload' ===
          (await e('Update available', { actions: ['reload', 'dismiss'] })) &&
          (async function () {
            const e = await navigator.serviceWorker.getRegistration();

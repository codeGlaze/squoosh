  ...
  var t,
    o =
      ...
      function (r) {
        ...
        if (r.locateFile)
          q((z = 'webp_dec.wasm')) ||
            ((H = z), (z = r.locateFile ? r.locateFile(H, f) : f + H));
        else var z = new URL('/c/webp_dec-12bed04a.wasm', n.uri).toString();
        function N(n) {
          try {
        ...
        !(function () {
          ...
          (tn = r.BindingError = en(Error, 'BindingError')),
          (an = r.InternalError = en(Error, 'InternalError')),
          (r.count_emval_handles = pn),
          (r.get_first_emval = vn),
          (_n = r.UnboundTypeError = en(Error, 'UnboundTypeError'));
        var In = {
          e: function (n, r) {},
            ...
            (n = X(n)),
              ...
              (function (n, r, e) {
                function t(r) {
                  var t = e(r);
                  t.length !== n.length &&
                    un('Mismatched type converter count');
          ...
          d: function (n) {
            return 0 === n
              ? dn(Wn())
              : ((n = void 0 === (e = Cn[(r = n)]) ? X(r) : e), dn(Wn()[n]));
            var r, e;
          },
          j: function (n) {
            n > 4 && (sn[n].refcount += 1);

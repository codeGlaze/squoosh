  ...
  var t,
    o =
      ...
      function (r) {
        ...
        function S(n) {
          (y = n),
            (r.HEAP8 = g = new Int8Array(n)),
            (r.HEAP16 = w = new Int16Array(n)),
            (r.HEAP32 = b = new Int32Array(n)),
            (r.HEAPU8 = m = new Uint8Array(n)),
            (r.HEAPU16 = T = new Uint16Array(n)),
            (r.HEAPU32 = A = new Uint32Array(n)),
            (r.HEAPF32 = _ = new Float32Array(n)),
        ...
        if (r.locateFile)
          q((z = 'webp_enc_simd.wasm')) ||
            ((V = z), (z = r.locateFile ? r.locateFile(V, f) : f + V));
        else
          var z = new URL('/c/webp_enc_simd-75acd924.wasm', n.uri).toString();
        function N(n) {
          try {
        ...
        (tn = r.InternalError = en(Error, 'InternalError')),
          ...
          (sn = r.BindingError = en(Error, 'BindingError')),
          (r.count_emval_handles = yn),
          (r.get_first_emval = gn),
          (Fn = r.UnboundTypeError = en(Error, 'UnboundTypeError'));
        var On = {
          x: function (n, r) {},
          l: function (n) {
            var r = G[n];
          ...
          d: function (n, r, e) {
            ...
            var o = t.constructor,
              a = Object.create(t.constructor.prototype, {
                value: { value: e },
                constructor: { value: rn(t.name + '_' + r, function () {}) },
              });
            (o.values[e] = a), (o[r] = a);
          },
          j: function (n, r, e) {
            ...
            pn(n, {
              ...
              toWireType: function (n, r) {
                if ('number' != typeof r && 'boolean' != typeof r)
                  throw new TypeError(
                    'Cannot convert "' + _n(r) + '" to ' + this.name,
                  );
                return r;
              },
              argPackAdvance: 8,
            ...
            pn(n, {
              ...
              toWireType: function (n, e) {
                if ('number' != typeof e && 'boolean' != typeof e)
                  throw new TypeError(
                    'Cannot convert "' + _n(e) + '" to ' + this.name,
                  );
                if (e < t || e > o)
                  throw new TypeError(
                    'Passing a number "' +
          ...
          w: function (n) {
            return 0 === n
              ? mn(In())
              : ((n = void 0 === (e = Rn[(r = n)]) ? fn(r) : e), mn(In()[n]));
            var r, e;
          },
          v: function (n) {
            n > 4 && (dn[n].refcount += 1);
          ...
          o: function (n, e, t, o) {
            n = (function (n) {
              return (
                n || ln('Cannot use deleted val. handle = ' + n), dn[n].value
              );
            })(n);
            var a = Un[e];
            return (

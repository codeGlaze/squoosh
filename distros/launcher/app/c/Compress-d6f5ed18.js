define([
  'require',
  'exports',
  './initial-app-6fa33816',
  './util-06ce6ead',
], function (e, t, i, n) {
  const s = '_options-1-theme_k3l4d_43',
    o = '_options-2-theme_k3l4d_56';
  function a(e, t) {
  ...
  async function r(e, t, i) {
    ...
    let o;
    if ((s.putImageData(e, 0, 0), 'toBlob' in n))
      o = await new Promise((e) => n.toBlob(e, t, i));
    else {
  ...
  function c(e, t) {
    ...
    for (const i in t) if (!(i in e)) return !1;
    return !0;
  }
  const d = new Map();
  const p = new Map([
  ...
  async function u(e) {
    const t = await (function (e) {
      ...
      i = Array.from(new Uint8Array(t))
        .map((e) => String.fromCodePoint(e))
        .join('');
    for (const [e, t] of p) if (e.test(i)) return t;
    return '';
  }
  async function g(e) {
    ...
    try {
      return await (async function (e) {
        ...
        const i = new Promise((e, i) => {
          (t.onload = () => e()),
            (t.onerror = () => i(Error('Image loading error')));
        });
  ...
  async function b(e, t) {
    ...
    if (i !== n && 0 !== s)
      return (
        ...
        (e.style.transition = `height ${s}ms ${o}`),
        (e.style.height = n + 'px'),
        new Promise((t) => {
          const i = (n) => {
            n.target === e &&
              ...
              e.removeEventListener('transitioncancel', i),
              t());
          };
      ...
      Promise.race([
        ...
        new Promise((t, i) => {
          e.addEventListener('abort', () =>
            i(new DOMException('AbortError', 'AbortError')),
          );
        }),
      ])
    );
  ...
  var B = Object.freeze({
    ...
    mimeType: 'image/png',
    extension: 'png',
    defaultOptions: { level: 2, interlace: !1 },
  });
  var q = Object.freeze({
    __proto__: null,
    label: 'QOI',
  ...
  const G = (e) =>
    ...
    ie = (e) =>
      i.h(
        G,
        { ...e },
        i.h('path', { d: 'M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z' }),
      ),
    ne = (e) => i.h(G, { ...e }, i.h('path', { d: 'M19 13H5v-2h14v2z' })),
    se = (e) =>
      i.h(
        G,
        { ...e },
    ...
    he = () =>
      i.h(
        ...
        i.h(
          ...
          i.h('path', { d: 'M9 12a3 3 0 1 0 6 0a3 3 0 0 0-6 0' }),
        ),
      ),
    ce = () =>
      i.h(
  ...
  class de extends i.d {
    render(e) {
      return i.h(
        'div',
        { class: '_checkbox_75c6j_1' },
        e.checked
          ? e.disabled
            ? i.h(oe, { class: `${W} _disabled_75c6j_44` })
            : i.h(oe, { class: `${W} _checked_75c6j_40` })
          : i.h(se, { class: W }),
        i.h('input', {
          class: '_real-checkbox_75c6j_27',
          type: 'checkbox',
          ...e,
        }),
      );
  ...
  i.appendCss('._children-exiting_1vpum_1>*{pointer-events:none}');
  class pe extends i.d {
    static getDerivedStateFromProps(e, t) {
      return !e.children && t.children
        ? { children: e.children, outgoingChildren: t.children }
        : e.children !== t.children
        ? { children: e.children, outgoingChildren: void 0 }
        : null;
    }
    async componentDidUpdate(e, t) {
      let i, n;
      if (t.children && !this.state.children)
        (i = this.base.getBoundingClientRect().height), (n = 0);
      else {
        if (t.children || !this.state.children) return;
        (i = 0), (n = this.base.getBoundingClientRect().height);
      }
      (this.base.style.overflow = 'hidden'),
        await b(this.base, { duration: 300, from: i, to: n }),
        (this.base.style.height = ''),
        (this.base.style.overflow = ''),
        this.setState({ outgoingChildren: void 0 });
    }
    render({}, { children: e, outgoingChildren: t }) {
      return i.h(
        'div',
        { class: t ? '_children-exiting_1vpum_1' : '' },
        t || e,
      );
    }
  }
  i.appendCss(
    '._select_1onzk_1{position:relative}._builtin-select_1onzk_5{background:var(--black);border-radius:4px;font:inherit;padding:7px 25px 7px 10px;-webkit-appearance:none;-moz-appearance:none;border:none;color:#fff;width:100%}._arrow_1onzk_19{position:absolute;right:8px;top:50%;transform:translateY(-50%);fill:#fff;width:10px;pointer-events:none}._large_1onzk_29{padding:10px 35px 10px 10px;background:var(--dark-gray)}._large_1onzk_29 ._arrow_1onzk_19{right:13px}',
  );
  class ue extends i.d {
    render(e) {
      ...
      return i.h(
        'div',
        { class: '_select_1onzk_1' },
        i.h('select', {
          class: '_builtin-select_1onzk_5 ' + (t ? '_large_1onzk_29' : ''),
          ...n,
        }),
        i.h('div', { class: '_arrow_1onzk_19' }, i.h(ae, null)),
      );
    }
  }
  i.appendCss(
    '._range_i4fg8_1{position:relative;z-index:0;display:grid;grid-template-columns:1fr auto}._label-text_i4fg8_8{color:#fff}._range-wc-container_i4fg8_12{position:relative;z-index:1;grid-row:2/3;grid-column:1/3}._range-wc_i4fg8_12{width:100%}._text-input_i4fg8_23{grid-row:1/2;grid-column:2/3;text-align:right;background:transparent;color:inherit;font:inherit;border:none;padding:2px 5px;box-sizing:border-box;text-decoration:underline;text-decoration-style:dotted;text-decoration-color:var(--main-theme-color);text-underline-position:under;width:54px;position:relative;left:5px}._text-input_i4fg8_23:focus{background:#fff;color:#000}._text-input_i4fg8_23{-moz-appearance:textfield}._text-input_i4fg8_23::-webkit-inner-spin-button,._text-input_i4fg8_23::-webkit-outer-spin-button{-moz-appearance:none;-webkit-appearance:none;margin:0}',
  );
  const ge = '_value-display_1fqga_64',
    me = '_touch-active_1fqga_102';
  i.appendCss(
    'range-input{position:relative;display:flex;height:18px;width:130px;margin:2px;font:inherit;line-height:16px;overflow:visible}range-input[disabled]{filter:grayscale(1)}range-input:before{content:"";display:block;position:absolute;top:8px;left:0;width:100%;height:2px;border-radius:1px;background:linear-gradient(var(--main-theme-color),var(--main-theme-color)) 0/var(--value-percent,0) 100% no-repeat var(--medium-light-gray)}._input_1fqga_30{position:relative;width:100%;padding:0;margin:0;opacity:0}._thumb_1fqga_38{pointer-events:none;position:absolute;bottom:3px;left:0;margin-left:-6px;background:var(--main-theme-color);border-radius:50%;width:12px;height:12px}range-input:focus-within ._thumb_1fqga_38{outline:2px solid #fff}._thumb-wrapper_1fqga_54{position:absolute;left:6px;right:6px;bottom:0;height:0;overflow:visible;transform:translate(var(--value-percent,0))}._value-display_1fqga_64{position:absolute;box-sizing:border-box;left:0;bottom:3px;width:32px;height:62px;text-align:center;padding:8px 3px 0;margin:0 0 0 -16px;transform-origin:50% 90%;opacity:.0001;transform:scale(.2);color:#fff;font:inherit;font-size:calc(100% - var(--value-width, 3)/5*0.2em);text-overflow:clip;text-shadow:0 -.5px 0 rgba(0,0,0,.4);transition:all .2s ease;transition-property:opacity,transform;will-change:transform;pointer-events:none;overflow:hidden}._value-display_1fqga_64>svg{position:absolute;top:0;left:0;width:100%;height:100%;fill:var(--main-theme-color)}._value-display_1fqga_64>span{position:relative}._touch-active_1fqga_102+._thumb-wrapper_1fqga_54 ._value-display_1fqga_64{opacity:1;transform:scale(1)}._touch-active_1fqga_102+._thumb-wrapper_1fqga_54 ._thumb_1fqga_38{box-shadow:0 1px 3px rgba(0,0,0,.5)}',
  );
  const _e = ['focus', 'blur'],
    fe = ['input', 'change'],
    ve = ['name', 'min', 'max', 'step', 'value', 'disabled'],
    be = ['name', 'min', 'max', 'step', 'value', 'disabled'];
  class we extends HTMLElement {
    constructor() {
      let e;
      super(),
        (this._ignoreChange = !1),
        (this._retargetEvent = (e) => {
        ...
        (this._update = () => {
          ...
          (this._valueDisplay.textContent = n),
            this.style.setProperty('--value-percent', i + '%'),
            this.style.setProperty('--value-width', '' + n.length);
        }),
        (this._input = document.createElement('input')),
        (this._input.type = 'range'),
        (this._input.className = '_input_1fqga_30'),
        this.addEventListener('pointerdown', (t) => {
          if (e) return;
          (e = t.pointerId), this._input.classList.add(me);
          const i = (t) => {
            t.pointerId === e &&
              ((e = void 0),
              this._input.classList.remove(me),
      ...
      for (const e of _e)
        this._input.addEventListener(e, this._retargetEvent, !0);
      for (const e of fe) this._input.addEventListener(e, this._update, !0);
    }
    ...
    connectedCallback() {
      this.contains(this._input) ||
        ((this.innerHTML = `<div class="_thumb-wrapper_1fqga_54"><div class="_thumb_1fqga_38"></div><div class="${ge}"><svg width="32" height="62"><path d="M27.3 27.3C25 29.6 17 35.8 17 43v3c0 3 2.5 5 3.2 5.8a6 6 0 1 1-8.5 0C12.6 51 15 49 15 46v-3c0-7.2-8-13.4-10.3-15.7A16 16 0 0 1 16 0a16 16 0 0 1 11.3 27.3z"/></svg><span></span></div></div>`),
        this.insertBefore(this._input, this.firstChild),
        (this._valueDisplay = this.querySelector('.' + ge + ' > span')),
        this._update());
    }
    get labelPrecision() {
  ...
  customElements.define('range-input', we);
        ...
        (this.onTextInput = (e) => {
          ...
          t.value.trim() &&
            ...
            this.rangeWc.dispatchEvent(
              new InputEvent('input', { bubbles: e.bubbles }),
            ));
        }),
        (this.onTextFocus = () => {
          this.setState({ textFocused: !0 });
        }),
        (this.onTextBlur = () => {
          this.setState({ textFocused: !1 });
        });
    }
    render(e, t) {
      const { children: n, ...s } = e,
        { value: o, min: a, max: r, step: l } = e,
        h = t.textFocused ? this.inputEl.value : o;
      return i.h(
        'label',
        { class: '_range_i4fg8_1' },
        i.h('span', { class: '_label-text_i4fg8_8' }, n),
        i.h(
          'div',
          { class: '_range-wc-container_i4fg8_12' },
          i.h('range-input', {
            ref: i.linkRef(this, 'rangeWc'),
            class: '_range-wc_i4fg8_12',
            ...s,
          }),
        ),
        i.h('input', {
  ...
  class ze extends i.d {
    constructor() {
      super(...arguments),
        (this.state = { showAdvanced: !1 }),
        (this._inputChangeCallbacks = new Map()),
        (this._inputChange = (e, t) => (
          this._inputChangeCallbacks.has(e) ||
            this._inputChangeCallbacks.set(e, (i) => {
              const n = i.target,
                s =
                  'boolean' === t
                    ? 'checked' in n
                ...
                a = { ...this.state, ...o },
                r = {
                  quality: a.lossless ? Se : a.quality,
                  qualityAlpha:
                    a.lossless || !a.separateAlpha ? -1 : a.alphaQuality,
    ...
    static getDerivedStateFromProps(e, t) {
      ...
      const { options: i } = e,
        n =
          i.quality === Se &&
          (-1 == i.qualityAlpha || i.qualityAlpha == Se) &&
          3 == i.subsample,
        s = -1 !== i.qualityAlpha;
      return {
        options: i,
        lossless: n,
        quality: n ? x.quality : i.quality,
        separateAlpha: s,
    ...
    render(
      ...
      return i.h(
        ...
        i.h(
          'label',
          { class: H },
          i.h(ke, { checked: r, onChange: Ce(this, 'showAdvanced') }),
          'Advanced settings',
        ),
        i.h(
          pe,
                  ...
                  i.h(
                    ...
                    i.h(
                      ...
                      i.h(
                        ...
                        i.h('option', { value: '0' }, '4:0:0'),
                        i.h('option', { value: '1' }, '4:2:0'),
                        i.h('option', { value: '2' }, '4:2:2'),
                        i.h('option', { value: '3' }, '4:4:4'),
                      ),
                    ),
                    i.h(
                      pe,
                    ...
                    i.h(
                      ...
                      i.h(
                        ...
                        i.h('option', { value: 0 }, 'Auto'),
                        i.h('option', { value: 1 }, 'PSNR'),
                        i.h('option', { value: 2 }, 'SSIM'),
                      ),
                    ),
                  ),
              ),
  ...
  var Ie = Object.freeze({
    ...
    encode: (e, t, i, n) => r(i, k),
  });
  const Pe = (function (e = {}) {
    const { min: t = 0, max: n = 100, step: s = 1 } = e;
    class o extends i.d {
      constructor() {
        super(...arguments),
          (this.onChange = (e) => {
  ...
  var Le = Object.freeze({ __proto__: null, encode: (e, t, i, n) => r(i, I) });
  class Be extends i.d {
    constructor() {
      super(...arguments),
        (this.state = { lossless: !1 }),
        (this._inputChangeCallbacks = new Map()),
        (this._inputChange = (e, t) => (
          this._inputChangeCallbacks.has(e) ||
            this._inputChangeCallbacks.set(e, (i) => {
  ...
  class Re extends i.d {
    constructor() {
      super(...arguments),
        (this.state = { showAdvanced: !1 }),
        (this.onChange = (e) => {
          const t = e.currentTarget.closest('form'),
            { options: i } = this.props,
            n = {
              ...this.props.options,
              baseline: f(t.baseline, i.baseline),
              progressive: f(t.progressive, i.progressive),
              optimize_coding: f(t.optimize_coding, i.optimize_coding),
              trellis_multipass: f(t.trellis_multipass, i.trellis_multipass),
              trellis_opt_zero: f(t.trellis_opt_zero, i.trellis_opt_zero),
              trellis_opt_table: f(t.trellis_opt_table, i.trellis_opt_table),
              auto_subsample: f(t.auto_subsample, i.auto_subsample),
              separate_chroma_quality: f(
                t.separate_chroma_quality,
                i.separate_chroma_quality,
              ),
              quality: m(t.quality, i.quality),
              chroma_quality: m(t.chroma_quality, i.chroma_quality),
              chroma_subsample: m(t.chroma_subsample, i.chroma_subsample),
              smoothing: m(t.smoothing, i.smoothing),
              color_space: m(t.color_space, i.color_space),
              quant_table: m(t.quant_table, i.quant_table),
              trellis_loops: m(t.trellis_loops, i.trellis_loops),
            };
    ...
    render({ options: e }, { showAdvanced: t }) {
      return i.h(
        ...
        i.h(
          'label',
          { class: H },
          i.h(ke, { checked: t, onChange: Ce(this, 'showAdvanced') }),
          'Advanced settings',
        ),
        i.h(
          pe,
            ...
            ? i.h(
                ...
                i.h(
                  ...
                  i.h(
                    ...
                    i.h('option', { value: 1 }, 'Grayscale'),
                    i.h('option', { value: 2 }, 'RGB'),
                    i.h('option', { value: 3 }, 'YCbCr'),
                  ),
                ),
                i.h(
                  pe,
                ...
                i.h(
                  ...
                  i.h(
                    ...
                    i.h('option', { value: '0' }, 'JPEG Annex K'),
                    i.h('option', { value: '1' }, 'Flat'),
                    i.h('option', { value: '2' }, 'MSSIM-tuned Kodak'),
                    i.h('option', { value: '3' }, 'ImageMagick'),
                    i.h('option', { value: '4' }, 'PSNR-HVS-M-tuned Kodak'),
                    i.h('option', { value: '5' }, 'Klein et al'),
                    i.h('option', { value: '6' }, 'Watson et al'),
                    i.h('option', { value: '7' }, 'Ahumada et al'),
                    i.h('option', { value: '8' }, 'Peterson et al'),
                  ),
                ),
                i.h(
                  'label',
  ...
  class De extends i.d {
    constructor() {
      super(...arguments),
        (this.onChange = (e) => {
          const t = e.currentTarget.closest('form'),
            i = { level: m(t.level), interlace: f(t.interlace) };
  ...
  function He(e, t) {
    const i = Fe.findIndex(([i, n]) => i === t && n === e);
    return -1 !== i ? i : 6;
  }
      ...
      super(...arguments),
        ...
        (this.onChange = (e) => {
          const t = e.currentTarget.closest('form'),
            ...
            s = m(t.lossless_preset, He(n.quality, n.method)),
            o = {
              ...n,
              lossless: i,
              quality: i ? Fe[s][1] : m(t.quality, n.quality),
              method: i ? Fe[s][0] : m(t.method_input, n.method),
              image_hint: _(t.image_hint, n.image_hint) ? 3 : 0,
              exact: _(t.exact, n.exact),
              alpha_compression: _(t.alpha_compression, n.alpha_compression),
              autofilter: _(t.autofilter, n.autofilter),
              filter_type: _(t.filter_type, n.filter_type),
              use_sharp_yuv: _(t.use_sharp_yuv, n.use_sharp_yuv),
              near_lossless: 100 - m(t.near_lossless, 100 - n.near_lossless),
              alpha_quality: m(t.alpha_quality, n.alpha_quality),
              alpha_filtering: m(t.alpha_filtering, n.alpha_filtering),
              sns_strength: m(t.sns_strength, n.sns_strength),
              filter_strength: m(t.filter_strength, n.filter_strength),
              filter_sharpness:
                7 - m(t.filter_sharpness, 7 - n.filter_sharpness),
              pass: m(t.pass, n.pass),
              preprocessing: m(t.preprocessing, n.preprocessing),
              segments: m(t.segments, n.segments),
              partitions: m(t.partitions, n.partitions),
            };
            ...
            ? i.h(
                ...
                i.h(
                  ...
                  i.h(
                    ...
                    i.h('option', { value: '0' }, 'None'),
                    i.h('option', { value: '1' }, 'Segment smooth'),
                    i.h('option', { value: '2' }, 'Pseudo-random dithering'),
                  ),
                ),
                i.h(
                  'div',
  ...
  class Ne extends i.d {
    ...
    static getDerivedStateFromProps(e, t) {
      ...
      return (
        i.quality > 95
          ? ((n.lossless = !0), (n.slightLoss = 100 - i.quality))
          : ((n.quality = i.quality), (n.lossless = !1)),
        n
      );
    }
    render(
          ...
          !r &&
            i.h(
              ...
              i.h(
                'label',
                { class: H },
                i.h(ke, { checked: u, onChange: Ce(this, 'showAdvanced') }),
                'Advanced settings',
              ),
              i.h(
                pe,
                  ...
                  i.h(
                    ...
                    i.h(
                      ...
                      i.h(
                        ...
                        i.h('option', { value: 3 }, 'Auto'),
                        i.h('option', { value: 0 }, 'Vary'),
                        i.h('option', { value: 1 }, 'Half'),
                        i.h('option', { value: 2 }, 'Off'),
                      ),
                    ),
                    i.h(
                      'label',
                      ...
                      i.h(
                        ...
                        i.h('option', { value: 0 }, 'YCoCg'),
                        i.h('option', { value: 1 }, 'YCbCr'),
                        i.h('option', { value: 3 }, 'YIQ'),
                      ),
                    ),
                    i.h(
                      'label',
  ...
  const Qe = ['triangle', 'catrom', 'mitchell', 'lanczos3', 'hqx'],
    We = {
      avif: { meta: C, ...Ee },
      browserGIF: { meta: S, ...Ie },
      browserJPEG: { meta: E, ...Me },
      browserPNG: { meta: P, ...Le },
      jxl: { meta: M, ...qe },
      mozJPEG: { meta: L, ...Oe },
      oxiPNG: { meta: B, ...Te },
      qoi: { meta: q, ...Ue },
    ...
    Ge = {
      quantize: { enabled: !1, zx: 0, maxNumColors: 256, dither: 1 },
      resize: {
        enabled: !1,
        width: 1,
        height: 1,
    ...
    Xe = {
      crop: { enabled: !1, x: 0, y: 0, width: 0, height: 0 },
      rotate: { rotate: 0 },
    };
  class Je {
    constructor(e) {
      (this.id = -1),
        ...
        self.Touch && e instanceof Touch
          ...
          : Ze(e) && (this.id = e.pointerId);
    }
    getCoalesced() {
      if ('getCoalescedEvents' in this.nativePointer) {
        const e = this.nativePointer.getCoalescedEvents().map((e) => new Je(e));
        if (e.length > 0) return e;
      }
      return [this];
    }
  }
  const Ze = (e) => 'pointerId' in e,
    Ke = (e) => 'changedTouches' in e,
    $e = () => {};
  class et {
    constructor(
      e,
      ...
      (this._element = e),
        ...
        (this._touchStart = (e) => {
          for (const t of Array.from(e.changedTouches))
            this._triggerPointerStart(new Je(t), e);
        }),
        (this._move = (e) => {
          if (
            !(
              Ke(e) ||
              (Ze(e) && this._excludeFromButtonsCheck.has(e.pointerId)) ||
              0 !== e.buttons
            )
          )
        ...
        (this._pointerEnd = (e) => {
          if (this._triggerPointerEnd(new Je(e), e))
            if (Ze(e)) {
        ...
        (this._touchEnd = (e) => {
          for (const t of Array.from(e.changedTouches))
            this._triggerPointerEnd(new Je(t), e);
        }),
        (this._startCallback = t),
        (this._moveCallback = i),
        (this._endCallback = n),
        (this._rawUpdates = s && 'onpointerrawupdate' in window),
        self.PointerEvent && !o
  ...
  function ot() {
    return (
      st || (st = document.createElementNS('http://www.w3.org/2000/svg', 'svg'))
    );
  }
  function at() {
    return ot().createSVGMatrix();
  }
  function rt() {
    return ot().createSVGPoint();
  }
  i.appendCss(
  ...
  class lt extends HTMLElement {
    ...
    scaleTo(e, t = {}) {
      let { originX: i = 0, originY: n = 0 } = t;
      const { relativeTo: s = 'content', allowChangeEvent: o = !1 } = t,
        a = 'content' === s ? this._positioningEl : this;
      if (!a || !this._positioningEl)
        return void this.setTransform({ scale: e, allowChangeEvent: o });
      const r = a.getBoundingClientRect();
      if (((i = nt(i, r.width)), (n = nt(n, r.height)), 'content' === s))
        (i += this.x), (n += this.y);
      else {
    ...
    setTransform(e = {}) {
      const { scale: t = this.scale, allowChangeEvent: i = !1 } = e;
      let { x: n = this.x, y: s = this.y } = e;
      ...
      (r = r.matrixTransform(h)),
        (l = l.matrixTransform(h)),
        r.x > o.width ? (n += o.width - r.x) : l.x < 0 && (n += -l.x),
        r.y > o.height ? (s += o.height - r.y) : l.y < 0 && (s += -l.y),
        this._updateTransform(t, n, s, i);
    }
    _updateTransform(e, t, i, n) {
      if (
        !(e < 0.01) &&
        !(e > 1e5) &&
        (e !== this.scale || t !== this.x || i !== this.y) &&
        ((this._transform.e = t),
        (this._transform.f = i),
  ...
  class pt extends HTMLElement {
      ...
      super(),
        ...
        (this._onKeyDown = (e) => {
          ...
          if (!(t instanceof HTMLElement && t.closest('input')))
            if ('Digit1' === e.code || 'Numpad1' === e.code)
              (this._position = 0),
              ...
              (this._position = t[e] / 2),
                (this._relativePosition = this._position / t[e] / 2),
                this._setPosition();
            } else if ('Digit3' === e.code || 'Numpad3' === e.code) {
              const e = 'vertical' === this.orientation ? 'height' : 'width',
                t = this.getBoundingClientRect();
              (this._position = t[e]),
                (this._relativePosition = this._position / t[e]),
                this._setPosition();
            }
        }),
        (this._handle.className = ht),
        new MutationObserver(() => this._childrenChange()).observe(this, {
          childList: !0,
        });
      const e = new et(this._handle, {
        start: (t, i) =>
    ...
    connectedCallback() {
      this._childrenChange(),
        (this._handle.innerHTML =
          '<div class="_scrubber_mdt25_42"><svg viewBox="0 0 27 20"><path class="_arrow-left_mdt25_58" d="M9.6 0L0 9.6l9.6 9.6z"/><path class="_arrow-right_mdt25_62" d="M17 19.2l9.5-9.6L16.9 0z"/></svg>\n      </div>'),
    ...
    get legacyClipCompat() {
      return this.hasAttribute(ct);
    }
    set legacyClipCompat(e) {
      e ? this.setAttribute(ct, '') : this.removeAttribute(ct);
    }
    get orientation() {
    ...
    _pointerChange(e, t) {
      ...
      (this._position = this._positionOnPointerStart + (t[i] - e[i])),
        (this._position = Math.max(0, Math.min(this._position, s[n]))),
        (this._relativePosition = this._position / s[n]),
        this._setPosition();
    }
    _setPosition() {
  ...
  customElements.define('two-up', pt);
  const ut = '_pinch-zoom_1yi4k_25 abs-fill',
    gt = '_pinch-target_1yi4k_33',
    mt = '_button-group_1yi4k_68',
    _t = '_button_1yi4k_68',
    ft = '_zoom_1yi4k_75',
    vt = '_first-button_1yi4k_110 _button_1yi4k_68',
    bt = '_last-button_1yi4k_115 _button_1yi4k_68',
    wt = '_single-button_1yi4k_121 _button_1yi4k_68',
    yt = '_pixelated_1yi4k_171';
  function At(e, t, i, n) {
    ...
    for (const [e, t] of s.entries())
      e !== r
        ? (o = o[t] = xt(o[t]))
        : (o[t] = n ? Object.assign(xt(o[t]), i) : i);
    return a;
  }
  function xt(e) {
  ...
  function zt(e, t, i) {
    const n = St(Math.round(e.x), 0, t - 1),
      s = St(Math.round(e.y), 0, i - 1);
    return {
      x: n,
      y: s,
      width: St(Math.round(e.width), 1, t - n),
      height: St(Math.round(e.height), 1, i - s),
    };
  }
  function Et(e, t, i) {
    return 0 === e.x && 0 === e.y && e.width === t && e.height === i;
  }
  i.appendCss(
    '._output_1yi4k_1{display:contents}._output_1yi4k_1:before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:#000;opacity:.8;transition:opacity .5s ease}._output_1yi4k_1._alt-background_1yi4k_16:before{opacity:0}._pinch-zoom_1yi4k_25{outline:none;display:flex;justify-content:center;align-items:center}._pinch-target_1yi4k_33{will-change:auto;flex-shrink:0}._controls_1yi4k_42{display:flex;justify-content:center;overflow:hidden;flex-wrap:wrap;contain:content;grid-area:header;align-self:center;padding:9px 66px;position:relative;gap:6px;pointer-events:none}._controls_1yi4k_42>*{pointer-events:auto}@media (min-width:860px){._controls_1yi4k_42{padding:9px;flex-wrap:wrap-reverse;grid-area:viewportOpts;align-self:end}}._button-group_1yi4k_68{display:flex;position:relative;z-index:100}._button_1yi4k_68,._zoom_1yi4k_75{display:flex;align-items:center;box-sizing:border-box;background-color:rgba(29,29,29,.92);border:1px solid rgba(0,0,0,.67);border-right-width:0;line-height:1.1;white-space:nowrap;height:39px;padding:0 8px;font-size:1.2rem;cursor:pointer}._button_1yi4k_68:focus-visible,._zoom_1yi4k_75:focus-visible{box-shadow:0 0 0 2px #fff;outline:none;z-index:1}._button_1yi4k_68{color:#fff;margin:0}._button_1yi4k_68:hover{background:rgba(50,50,50,.92)}._button_1yi4k_68._active_1yi4k_104{background:rgba(72,72,72,.92);color:#fff}._first-button_1yi4k_110{border-radius:6px 0 0 6px}._last-button_1yi4k_115{border-radius:0 6px 6px 0;border-right-width:1px}._single-button_1yi4k_121{border-radius:6px;border-right-width:1px}._zoom_1yi4k_75{cursor:text;width:7rem;font:inherit;text-align:center;justify-content:center}._zoom_1yi4k_75:focus{box-shadow:inset 0 1px 4px rgba(0,0,0,.2),0 0 0 2px #fff}span._zoom_1yi4k_75{color:#939393;font-size:.8rem;line-height:1.2;font-weight:100}input._zoom_1yi4k_75{text-indent:3px}._zoom-value_1yi4k_152,input._zoom_1yi4k_75{font-size:1.2rem;letter-spacing:.05rem;font-weight:700;color:#fff}._zoom-value_1yi4k_152{margin:0 3px 0 0;padding:0 2px;border-bottom:1px dashed #999}._buttons-no-wrap_1yi4k_162{display:flex;pointer-events:none}._buttons-no-wrap_1yi4k_162>*{pointer-events:auto}._pixelated_1yi4k_171{image-rendering:crisp-edges;image-rendering:pixelated}',
  );
  const It = [
  ...
  class Pt extends i.d {
    constructor(e) {
      super(e),
        (this.dragMode = null),
        (this.dragStartRect = { x: 0, y: 0, width: 0, height: 0 }),
        (this.dragStartPointer = { x: 0, y: 0 }),
        (this.measure = () => {
          if (!this.containerEl) return;
          const e = this.containerEl.getBoundingClientRect();
          this.setState({
            containerWidth: e.width || 1,
            containerHeight: e.height || 1,
          });
        }),
        (this.onBackgroundPointerDown = (e) => {
          this.startDrag('new', e);
        }),
        (this.onSelectionPointerDown = (e) => {
          e.stopPropagation(), this.startDrag('move', e);
        }),
        (this.onHandlePointerDown = (e) => (t) => {
          t.stopPropagation(), this.startDrag(e, t);
        }),
        (this.onPointerMove = (e) => {
          if (!this.dragMode) return;
          const { width: t, height: i } = this.props.image,
            n = this.pointerToImage(e.clientX, e.clientY),
            s = n.x - this.dragStartPointer.x,
            o = n.y - this.dragStartPointer.y,
            a = this.dragStartRect;
          let r;
          if ('move' === this.dragMode)
            r = {
              x: St(a.x + s, 0, t - a.width),
              y: St(a.y + o, 0, i - a.height),
              width: a.width,
              height: a.height,
            };
          else if ('new' === this.dragMode) {
            const e = St(this.dragStartPointer.x, 0, t),
              s = St(this.dragStartPointer.y, 0, i),
              o = St(n.x, 0, t),
              a = St(n.y, 0, i);
            r = {
              x: Math.min(e, o),
            ...
            const e = this.dragMode;
            let n = a.x,
              l = a.y,
              h = a.x + a.width,
              c = a.y + a.height;
            e.includes('w') && (n = St(a.x + s, 0, h - 1)),
              e.includes('e') && (h = St(h + s, n + 1, t)),
              e.includes('n') && (l = St(a.y + o, 0, c - 1)),
              e.includes('s') && (c = St(c + o, l + 1, i)),
              (r = { x: n, y: l, width: h - n, height: c - l });
          }
        ...
        (this.onPointerUp = () => {
          ...
          const e = 'new' === this.dragMode;
          (this.dragMode = null),
            e &&
              (this.state.rect.width < 1 || this.state.rect.height < 1) &&
              this.selectAll();
        }),
        (this.onKeyDown = (e) => {
          'Escape' === e.key
            ? (e.preventDefault(), this.props.onCancel())
            : 'Enter' === e.key && (e.preventDefault(), this.apply());
        }),
        (this.onNumberInput = (e) => (t) => {
          const i = Number(t.target.value);
          if (Number.isNaN(i)) return;
          const { width: n, height: s } = this.props.image;
          this.setState((t) => {
            const o = { ...t.rect, [e]: i };
            return (
              (o.x = St(o.x, 0, n - 1)),
              (o.y = St(o.y, 0, s - 1)),
              (o.width = St(o.width, 1, n - o.x)),
              (o.height = St(o.height, 1, s - o.y)),
              { rect: o }
            );
          });
        }),
        ...
        (this.apply = () => {
          const { width: e, height: t } = this.props.image;
          this.props.onApply(zt(this.state.rect, e, t));
        });
      const { width: t, height: i } = e.image,
        n =
          e.initialRect && e.initialRect.width > 0
            ? zt(e.initialRect, t, i)
            : { x: 0, y: 0, width: t, height: i };
      this.state = { rect: n, containerWidth: 1, containerHeight: 1 };
    }
    componentDidMount() {
      this.measure(),
        'undefined' != typeof ResizeObserver && this.containerEl
    ...
    drawCanvas() {
      this.canvas && a(this.canvas, this.props.image);
    }
    getFit(e = this.state.containerWidth, t = this.state.containerHeight) {
      const { image: i } = this.props,
        n = Math.max(1, e - 48),
        s = Math.max(1, t - 48),
        o = Math.min(n / i.width, s / i.height);
      return {
        scale: o,
        offsetX: (e - i.width * o) / 2,
        offsetY: (t - i.height * o) / 2,
      };
    }
    pointerToImage(e, t) {
      const i = this.containerEl.getBoundingClientRect(),
        { scale: n, offsetX: s, offsetY: o } = this.getFit(i.width, i.height);
      return { x: (e - i.left - s) / n, y: (t - i.top - o) / n };
    }
    startDrag(e, t) {
      if (
        (t.preventDefault(),
        (this.dragMode = e),
        (this.dragStartPointer = this.pointerToImage(t.clientX, t.clientY)),
        'new' === e)
      ) {
        const e = {
          x: St(this.dragStartPointer.x, 0, this.props.image.width),
          y: St(this.dragStartPointer.y, 0, this.props.image.height),
          width: 0,
          height: 0,
        };
        (this.dragStartRect = e), this.setState({ rect: e });
      } else this.dragStartRect = { ...this.state.rect };
      window.addEventListener('pointermove', this.onPointerMove),
        window.addEventListener('pointerup', this.onPointerUp);
    }
    render(
      { image: e, onCancel: t },
      { rect: n, containerWidth: s, containerHeight: o },
    ) {
      const { scale: a, offsetX: r, offsetY: l } = this.getFit(s, o),
        h = r + n.x * a,
        c = l + n.y * a,
        d = n.width * a,
        p = n.height * a,
      ...
      return i.h(
        ...
        i.h(
          'div',
          {
            ref: i.linkRef(this, 'containerEl'),
          ...
          i.h(
            ...
            It.map((e) =>
              i.h('div', {
                key: e.mode,
                onPointerDown: this.onHandlePointerDown(e.mode),
                style: {
                  position: 'absolute',
                  left: 100 * e.sx + '%',
                  top: 100 * e.sy + '%',
          ...
          ['x', 'y', 'width', 'height'].map((e) =>
            i.h(
              ...
              i.h(
                ...
                'width' === e ? 'W' : 'height' === e ? 'H' : e,
              ),
              i.h('input', {
                type: 'number',
                min: 'width' === e || 'height' === e ? 1 : 0,
                value: u(n[e]),
                onInput: this.onNumberInput(e),
                style: { width: '72px' },
              }),
            ),
          ),
          i.h('div', { style: { flex: 1 } }),
          i.h('button', { type: 'button', onClick: this.selectAll }, 'Reset'),
          i.h('button', { type: 'button', onClick: t }, 'Cancel'),
          i.h('button', { type: 'button', onClick: this.apply }, 'Apply crop'),
        ),
      );
    }
  }
  ...
  class Lt extends i.d {
    constructor() {
      super(...arguments),
        ...
        (this.toggleAliasing = () => {
          this.setState((e) => ({ aliasing: !e.aliasing }));
        }),
        ...
        (this.zoomIn = () => {
          ...
          this.pinchZoomLeft.scaleTo(1.25 * this.state.scale, Mt);
        }),
        (this.zoomOut = () => {
          if (!this.pinchZoomLeft) throw Error('Missing pinch-zoom element');
          this.pinchZoomLeft.scaleTo(this.state.scale / 1.25, Mt);
        }),
        (this.onRotateClick = () => {
          const { preprocessorState: e } = this.props;
          if (!e) return;
          const t = kt(e, 'rotate.rotate', (e.rotate.rotate + 90) % 360);
          this.props.onPreprocessorChange(t);
        }),
        (this.onOpenClick = () => {
          var e;
          null === (e = this.fileInput) || void 0 === e || e.click();
        }),
        (this.onFileChange = (e) => {
          const t = e.target,
            i = t.files ? Array.from(t.files) : [];
          (t.value = ''), i.length && this.props.onNewFiles(i);
        }),
        (this.onCropClick = () => {
          this.props.source && this.setState({ cropMode: !0 });
        }),
        (this.onCropCancel = () => {
          this.setState({ cropMode: !1 });
        }),
        (this.onCropApply = (e) => {
          this.setState({ cropMode: !1 });
          const { preprocessorState: t, source: i } = this.props;
          if (!t || !i) return;
          const n = kt(t, 'crop', {
            enabled: !Et(e, i.decoded.width, i.decoded.height),
            x: e.x,
            y: e.y,
            width: e.width,
            height: e.height,
          });
          this.props.onPreprocessorChange(n);
        }),
        ...
        (this.onScaleInputChanged = (e) => {
          ...
          if (!isNaN(i)) {
            if (!this.pinchZoomLeft) throw Error('Missing pinch-zoom element');
            this.pinchZoomLeft.scaleTo(i / 100, Mt);
          }
        }),
        ...
        (this.onRetargetableEvent = (e) => {
          const t = e.target;
          if (!this.pinchZoomLeft) throw Error('Missing pinch-zoom element');
          if ('wheel' !== e.type && t.closest(`.${ht}`)) return;
          if (this.retargetedEvents.has(e)) return;
          e.stopImmediatePropagation(), e.preventDefault();
          const i = new e.constructor(e.type, e);
          this.retargetedEvents.add(i),
            this.pinchZoomLeft.dispatchEvent(i),
            'touchend' === e.type &&
    ...
    componentDidMount() {
      ...
      this.pinchZoomLeft.setTransform({
        ...
        this.canvasLeft && e && a(this.canvasLeft, e),
        this.canvasRight && t && a(this.canvasRight, t);
    }
    componentDidUpdate(e, t) {
      ...
      if (r) c.setTransform({ allowChangeEvent: !0, x: 0, y: 0, scale: 1 });
      else if (l && h && l !== h) {
        const e = 1 - c.scale,
          t = (l.width / 2) * e,
          i = (l.height / 2) * e;
      ...
      s && s !== i && this.canvasLeft && a(this.canvasLeft, s),
        o && o !== n && this.canvasRight && a(this.canvasRight, o);
    }
    ...
    render(
      ...
      { scale: c, editingScale: d, altBackground: p, aliasing: u, cropMode: g },
    ) {
      const m = this.leftDrawable(),
        _ = this.rightDrawable(),
        f = s && s.preprocessed;
      return i.h(
        i.p,
        null,
        i.h(
          'div',
          { class: '_output_1yi4k_1 ' + (p ? '_alt-background_1yi4k_16' : '') },
          i.h(
            'two-up',
            {
              'legacy-clip-compat': !0,
              class: '_two-up_1yi4k_21 abs-fill',
            ...
            i.h(
              'pinch-zoom',
              { class: ut, ref: i.linkRef(this, 'pinchZoomRight') },
              i.h('canvas', {
                class: `${gt} ${u ? yt : ''}`,
        ...
        i.h(
          'div',
          { class: '_controls_1yi4k_42' },
          i.h(
            'div',
            { class: mt },
            i.h(
              'button',
              { class: wt, onClick: this.onOpenClick, title: 'Open image(s)' },
              i.h(te, null),
            ),
            i.h('input', {
              style: { display: 'none' },
            ...
            i.h(
              ...
              i.h(
                'button',
                {
                  ...
                  disabled: r,
                  title:
                    'Compress every loaded image with the current settings',
                },
                r ? 'Compressing…' : `Compress all (${a})`,
              ),
            ),
          i.h(
            'div',
            { class: mt },
            i.h('button', { class: vt, onClick: this.zoomOut }, i.h(ne, null)),
            d
              ? i.h('input', {
                  type: 'number',
                  step: '1',
                  ...
                  class: ft,
                  value: Math.round(100 * c),
                  onInput: this.onScaleInputChanged,
                  onBlur: this.onScaleInputBlur,
                })
              : i.h(
                  'span',
                  { class: ft, tabIndex: 0, onFocus: this.onScaleValueFocus },
                  i.h(
                    'span',
                    { class: '_zoom-value_1yi4k_152' },
                    Math.round(100 * c),
                  ),
                  '%',
                ),
            i.h('button', { class: bt, onClick: this.zoomIn }, i.h(ie, null)),
          ),
          i.h(
            'div',
            { class: mt },
            i.h(
              'button',
              { class: vt, onClick: this.onRotateClick, title: 'Rotate' },
              i.h($, null),
            ),
            i.h(
              'button',
        ...
        g &&
          ...
          i.h(Pt, {
            image: s.decoded,
            initialRect: o && o.crop.enabled ? o.crop : void 0,
          ...
          t
            ? i.h(
                ...
                i.h(
                  ...
                  i.h('option', { value: '0' }, 'Standard'),
                  i.h('option', { value: '1' }, 'ZX'),
                ),
              )
            : null,
        ),
  ...
  function Dt(e, t) {
    ...
    return (
      ...
      (function (e, t, i, n, s, o, r, l) {
        ...
        if (!d) throw new Error('Could not create canvas context');
        return (
          'pixelated' === l
            ? (d.imageSmoothingEnabled = !1)
            : (d.imageSmoothingQuality = l),
          d.drawImage(h, t, i, n, s, 0, 0, o, r),
          d.getImageData(0, 0, o, r)
        );
      })(e, i, s, o, r, t.width, t.height, t.method.slice(8))
    );
  }
  async function Tt(e, t, i, s) {
    if ('vector' === i.method) {
        ...
        return (
          'contain' === t.fitMethod &&
            ({
              ...
              sw: o,
              sh: a,
            } = n.getContainOffsets(o, a, t.width, t.height)),
          l(e, { sx: i, sy: s, sw: o, sh: a, width: t.width, height: t.height })
        );
      })(t.vectorImage, i);
    }
    return Ot(i) ? s.resize(e, t.preprocessed, i) : Dt(t.preprocessed, i);
  }
  const Ut = [0.25, 0.3333, 0.5, 1, 2, 3, 4];
  class Ft extends i.d {
    constructor(e) {
      super(e),
        ...
        (this.onPresetChange = (e) => {
          ...
          (this.form.width.value = Math.round(this.props.inputWidth * i) + ''),
            (this.form.height.value =
              Math.round(this.props.inputHeight * i) + ''),
            this.reportOptions();
        }),
    ...
    reportOptions() {
      ...
      const s = {
        ...
        premultiply: f(e.premultiply, !0),
        linearRGB: f(e.linearRGB, !0),
        fitMethod: v(e.fitMethod, n.fitMethod),
      };
    ...
    generatePresetValues(e, t) {
      for (const i of Ut)
        (this.presetWidths[i] = Math.round(e * i)),
          (this.presetHeights[i] = Math.round(t * i));
    }
    getPreset() {
    ...
    render({ options: e, isVector: t }, { maintainAspect: n }) {
      return i.h(
        'form',
        { ref: i.linkRef(this, 'form'), class: N, onSubmit: w },
        i.h(
          'label',
          { class: U },
          'Method:',
          i.h(
            ue,
            { name: 'resizeMethod', value: e.method, onChange: this.onChange },
            t && i.h('option', { value: 'vector' }, 'Vector'),
            i.h('option', { value: 'lanczos3' }, 'Lanczos3'),
            i.h('option', { value: 'mitchell' }, 'Mitchell'),
            i.h('option', { value: 'catrom' }, 'Catmull-Rom'),
            i.h('option', { value: 'triangle' }, 'Triangle (bilinear)'),
            i.h('option', { value: 'hqx' }, 'hqx (pixel art)'),
            i.h('option', { value: 'browser-pixelated' }, 'Browser pixelated'),
            i.h('option', { value: 'browser-low' }, 'Browser low quality'),
            i.h(
              'option',
              { value: 'browser-medium' },
              'Browser medium quality',
            ),
            i.h('option', { value: 'browser-high' }, 'Browser high quality'),
          ),
        ),
        i.h(
          'label',
          ...
          i.h(
            ...
            Ut.map((e) => i.h('option', { value: e }, 100 * e, '%')),
            i.h('option', { value: 'custom' }, 'Custom'),
          ),
        ),
        i.h(
          'label',
          ...
          n
            ...
            : i.h(
                ...
                i.h(
                  ...
                  i.h('option', { value: 'stretch' }, 'Stretch'),
                  i.h('option', { value: 'contain' }, 'Contain'),
                ),
              ),
        ),
      );
  ...
  const Ht = (async () => {
    ...
    return (
      await Promise.all(
        Object.entries(We).map(async ([t, i]) => {
  ...
  class jt extends i.d {
      ...
      super(),
        ...
        (this.onProcessorEnabledChange = (e) => {
          ...
          this.props.onProcessorOptionsChange(
            this.props.index,
            kt(this.props.processorState, `${i}.enabled`, t.checked),
          );
        }),
        (this.onQuantizerOptionsChange = (e) => {
          this.props.onProcessorOptionsChange(
            this.props.index,
            Ct(this.props.processorState, 'quantize', e),
          );
        }),
        (this.onResizeOptionsChange = (e) => {
          this.props.onProcessorOptionsChange(
            this.props.index,
            Ct(this.props.processorState, 'resize', e),
          );
        }),
        ...
        Ht.then((e) => this.setState({ supportedEncoderMap: e }));
    }
    componentDidMount() {
    ...
    render(
      { source: e, encoderState: t, processorState: n },
          ...
          t
            ? i.h(
                ...
                i.h(
                  ...
                  i.h(
                    'div',
                    { class: '_title-and-buttons_1pwky_96' },
                    'Edit',
                    i.h(
                      'button',
                      {
                        class:
                          '_copy-over-button_1pwky_122 _title-button_1pwky_104 unbutton',
                    ...
                    i.h(
                      ...
                      {
                        class:
                          '_save-button_1pwky_138 _title-button_1pwky_104 unbutton',
                    ...
                    i.h(
                      ...
                      {
                        class:
                          '_import-button_1pwky_139 _title-button_1pwky_104 unbutton ' +
                          (this.state.leftSideSettings || 0 !== this.props.index
                            ? ''
                            : Q) +
                          ' ' +
          ...
          s
            ? i.h(
                ...
                Object.entries(s).map(([e, t]) =>
                  i.h('option', { value: e }, t.meta.label),
                ),
              )
            : i.h(ue, { large: !0 }, i.h('option', null, 'Loading…')),
        ),
        i.h(
          pe,
          null,
  ...
  class Vt {
    ...
    match(e, t, i) {
      const n = this._entries.findIndex((n) => {
        ...
        for (const e in t) if (!c(t[e], n.processorState[e])) return !1;
        return !!c(i.options, n.encoderState.options);
      });
      if (-1 === n) return;
      const s = this._entries[n];
      return (
        0 !== n && (this._entries.splice(n, 1), this._entries.unshift(s)),
        { ...s }
      );
    }
  }
  const Nt = '_panel-heading_18nlm_1',
    Yt = '_panel-content_18nlm_4';
  i.appendCss(
    '._panel-content_18nlm_4{height:0;overflow:auto}._panel-content_18nlm_4[aria-expanded=true]{height:auto}',
  );
  const Qt = 'open-one-only';
  function Wt(e) {
    const t = e.closest('multi-panel > *, a, button');
    if (t && t.classList.contains(Nt)) return t;
  }
  async function Gt(e) {
    ...
    e.removeAttribute('content-expanded'),
      ...
      await null,
      await b(t, { from: i, to: 0, duration: 300 }),
      (t.style.height = '');
  }
  class Xt extends HTMLElement {
    ...
    attributeChangedCallback(e, t, i) {
      e === Qt && null === i && this._closeAll({ exceptFirst: !0 });
    }
    _onClick(e) {
      const t = Wt(e.target);
      t && this._toggle(t);
        ...
        (e.hasAttribute('content-expanded')
          ...
          : (this.openOneOnly && this._closeAll(),
            (async function (e) {
              ...
              await null,
                await b(t, { from: i, to: n, duration: 300 }),
                (t.style.height = '');
            })(e)));
    }
    _closeAll(e = {}) {
    ...
    _childrenChange() {
      ...
      for (; t; ) {
        ...
        t.classList.remove(Yt),
          ...
          t.classList.add(Nt),
          i.classList.add(Yt),
          (t.id = `panel-heading-${n}`),
          t.setAttribute('aria-controls', `panel-content-${n}`),
          (i.id = `panel-content-${n}`),
          i.setAttribute('aria-labelledby', `panel-heading-${n}`),
    ...
    _lastHeading() {
      ...
      if (e && e.classList.contains(Nt)) return e;
      const t = this.lastElementChild;
      return t ? t.previousElementSibling : void 0;
    }
    get openOneOnly() {
      return this.hasAttribute(Qt);
    }
    set openOneOnly(e) {
      e ? this.setAttribute(Qt, '') : this.removeAttribute(Qt);
    }
  }
  customElements.define('multi-panel', Xt);
  i.appendCss(
  ...
  const Jt = ['B', 'kB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'];
  class Zt extends i.d {
    constructor() {
      super(...arguments),
        (this.state = { showLoadingState: this.props.loading }),
    ...
    render(
      { source: e, imageFile: t, downloadUrl: n, flipSide: s, typeLabel: o },
      { showLoadingState: a },
    ) {
      const r =
          t &&
          (function (e) {
            const t = e < 0,
              i = t ? '-' : '';
            if ((t && (e = -e), e < 1)) return { value: i + e, unit: Jt[0] };
            const n = Math.min(Math.floor(Math.log10(e) / 3), Jt.length - 1);
            return {
              unit: Jt[n],
      ...
      return i.h(
        'div',
        {
          class:
            (s
              ? '_results-right_17s86_295 _results_17s86_26'
              : '_results-left_17s86_291 _results_17s86_26') +
            ' ' +
            (l ? '_is-original_17s86_345' : ''),
        },
        i.h('div', { class: '_expand-arrow_17s86_43' }, i.h(ae, null)),
        i.h(
          'div',
          { class: '_bubble_17s86_72' },
          i.h(
            'div',
            { class: '_bubble-inner_17s86_96' },
            i.h(
              'div',
              { class: '_size-info_17s86_120' },
              i.h(
                'div',
                { class: '_file-size_17s86_69' },
                r
                  ? i.h(
                      i.p,
                      null,
                      r.value,
                      ' ',
                      i.h('span', { class: '_unit_17s86_110' }, r.unit),
                      i.h('span', { class: '_type-label_17s86_114' }, ' ', o),
                    )
                  : '…',
              ),
            ),
            i.h(
              'div',
              { class: '_percent-info_17s86_139' },
              i.h(
                'svg',
                {
                  viewBox: '0 0 1 2',
                  class: '_big-arrow_17s86_156',
                  preserveAspectRatio: 'none',
                },
                i.h('path', { d: 'M1 0v2L0 1z' }),
              ),
              i.h(
                'div',
                { class: '_percent-output_17s86_169' },
                h &&
                  1 !== h &&
                  i.h(
                    'span',
                    { class: '_size-direction_17s86_187' },
                    h < 1 ? '↓' : '↑',
                  ),
                i.h('span', { class: '_size-value_17s86_198' }, c || 0),
                i.h('span', { class: '_percent-char_17s86_204' }, '%'),
              ),
            ),
          ),
        ),
        i.h(
          ...
          {
            class: a
              ? '_download-disable_17s86_279 _download_17s86_212'
              : '_download_17s86_212',
            href: n,
            download: t ? t.name : '',
            title: 'Download',
          ...
          i.h(
            'svg',
            { class: '_download-blobs_17s86_246', viewBox: '0 0 89.6 86.9' },
            i.h('title', null, 'Download'),
            i.h('path', {
          ...
          i.h('div', { class: '_download-icon_17s86_258' }, i.h(re, null)),
          a && i.h('loading-spinner', null),
        ),
      );
    }
  }
  ...
  class $t {
    ...
    _terminateWorker() {
      this._worker &&
        ...
        (this._worker = void 0),
        (this._workerApi = void 0));
    }
    terminate() {
      clearTimeout(this._workerTimeout), this._terminateWorker();
    }
    _startWorker() {
      (this._worker = new Worker('/c/features-worker-272a027f.js')),
        (this._workerApi = n.wrap(this._worker));
    }
  }
  for (const e of Kt)
        ...
        (this._queue = this._queue
          ...
          .then(async () => {
            ...
            return (
              ...
              A(t, this._workerApi[e](...i)).finally(() => {
      ...
      return await (async function (e, t) {
        return (
          ...
          l(
            await A(
              e,
              'createImageBitmap' in self ? createImageBitmap(t) : g(t),
            ),
          )
        );
      })(e, t);
    ...
    return (
      i.crop.enabled &&
        (s = (function (e, t) {
          ...
          const { x: i, y: n, width: s, height: o } = zt(t, e.width, e.height);
          if (Et({ x: i, y: n, width: s, height: o }, e.width, e.height))
            return e;
          const r = document.createElement('canvas');
          (r.width = e.width), (r.height = e.height), a(r, e);
          const l = document.createElement('canvas');
          (l.width = s), (l.height = o);
          const h = l.getContext('2d');
          if (!h) throw new Error('Could not create canvas context');
          return (
            h.drawImage(r, i, n, s, o, 0, 0, s, o), h.getImageData(0, 0, s, o)
          );
        })(s, i.crop)),
      0 !== i.rotate.rotate && (s = await n.rotate(e, s, i.rotate)),
      s
    );
  }
  async function ii(e, t, i, n) {
    ...
    return (
      i.resize.enabled && (s = await Tt(e, t, i.resize, n)),
      i.quantize.enabled && (s = await n.quantize(e, s, i.quantize)),
      s
    );
  }
  async function ni(e, t, i, n, s) {
    y(e);
    const o = We[i.type],
  ...
  async function si(e, t) {
    ...
    const i = new DOMParser(),
      ...
      o = s.documentElement;
    if (o.hasAttribute('width') && o.hasAttribute('height')) return g(t);
    ...
    return A(e, g(new Blob([l], { type: 'image/svg+xml' })));
  }
  async function oi(
    e,
    t,
    { preprocessorState: i, processorState: n, encoderState: s },
    o,
  ) {
    let a, r;
    y(e),
      t.type.startsWith('image/svg+xml')
        ? ((r = await si(e, t)), (a = l(r)))
        : (a = await ei(e, t, o));
    const h = {
      file: t,
      decoded: a,
      vectorImage: r,
      preprocessed: await ti(e, a, i, o),
    };
    return ni(e, await ii(e, h, n, o), s, t.name, o);
  }
  const ai = 1048576;
  function ri(e) {
  ...
  class li {
    constructor(
      e = (function () {
        ...
        return Math.min(Math.max(e - 1, 1), 3);
      })(),
    ) {
      (this.concurrency = Math.max(1, Math.floor(e))),
    ...
    dispose() {
      for (const e of this.bridges) e.terminate();
    }
    async run(e, t, i) {
      this.abortController = new AbortController();
      const { signal: n } = this.abortController,
        s = e.map((e) => ({ file: e, status: 'queued' })),
        o = () => (null == i ? void 0 : i(s.slice()));
      o();
      let a = 0;
      const r = Math.max(
        1,
        (function (e, t) {
          const i = e.reduce((e, t) => Math.max(e, t.size), 0);
          return i > 6 * ai ? 1 : i > 3 * ai ? Math.min(2, t) : t;
        })(e, this.bridges.length),
      );
      if (
        (await Promise.all(
          this.bridges.slice(0, r).map((i) =>
            (async (i) => {
              for (;;) {
                if (n.aborted) return;
                const r = a++;
                if (r >= e.length) return;
                (s[r] = { file: e[r], status: 'processing' }), o();
                try {
                  const o = await oi(n, e[r], t, i);
                  s[r] = {
                    file: e[r],
                    status: 'done',
                    result: o,
                  ...
                  if (ri(t))
                    return (
                      (s[r] = { file: e[r], status: 'cancelled' }), void o()
                    );
                  s[r] = {
                    file: e[r],
                    status: 'error',
        ...
        for (let e = 0; e < s.length; e++)
          ('processing' !== s[e].status && 'queued' !== s[e].status) ||
            (s[e] = { file: s[e].file, status: 'cancelled' });
        o();
      }
      return s;
    }
  ...
  'stream' in Blob.prototype ||
    ...
    'setBigUint64' in DataView.prototype ||
      Object.defineProperty(DataView.prototype, 'setBigUint64', {
        value(e, t, i) {
          const n = Number(0xffffffffn & t),
            s = Number(t >> 32n);
          this.setUint32(e + (i ? 0 : 4), n, i),
            this.setUint32(e + (i ? 4 : 0), s, i);
        },
      });
  var hi = (e) => new DataView(new ArrayBuffer(e)),
    ci = (e) => new Uint8Array(e.buffer || e),
    di = (e) => new TextEncoder().encode(String(e)),
    pi = (e) => Math.min(4294967295, Number(e)),
    ui = (e) => Math.min(65535, Number(e));
  function gi(e, t, i) {
    void 0 === t || t instanceof Date || (t = new Date(t));
    const n = void 0 !== e;
    if ((i || (i = n ? 436 : 509), e instanceof File))
      return {
        isFile: n,
        t: t || new Date(e.lastModified),
        bytes: e.stream(),
        mode: i,
      };
    if (e instanceof Response)
      return {
        isFile: n,
        t: t || new Date(e.headers.get('Last-Modified') || Date.now()),
        bytes: e.body,
        mode: i,
      };
    if (void 0 === t) t = new Date();
    else if (isNaN(t)) throw new Error('Invalid modification date.');
    if (!n) return { isFile: n, t: t, mode: i };
    if ('string' == typeof e) return { isFile: n, t: t, bytes: di(e), mode: i };
    if (e instanceof Blob)
      return { isFile: n, t: t, bytes: e.stream(), mode: i };
    if (e instanceof Uint8Array || e instanceof ReadableStream)
      return { isFile: n, t: t, bytes: e, mode: i };
    if (e instanceof ArrayBuffer || ArrayBuffer.isView(e))
      return { isFile: n, t: t, bytes: ci(e), mode: i };
    if (Symbol.asyncIterator in e)
      return { isFile: n, t: t, bytes: mi(e[Symbol.asyncIterator]()), mode: i };
  ...
  function _i(e) {
    return 'string' == typeof e ? di(e) : e instanceof Uint8Array ? e : ci(e);
  }
  function fi(e, t, i) {
    let [n, s] = (function (e) {
      return e
    ...
    if (e instanceof File)
      return { i: bi(n || di(e.name)), o: BigInt(e.size), u: s };
    if (e instanceof Response) {
      const t = e.headers.get('content-disposition'),
        ...
        l = i || +e.headers.get('content-length');
      return { i: bi(n || di(r)), o: BigInt(l), u: s };
    }
    return (
      (n = bi(n, void 0 !== e || void 0 !== i)),
      'string' == typeof e
        ? { i: n, o: BigInt(di(e).length), u: s }
        : e instanceof Blob
        ? { i: n, o: BigInt(e.size), u: s }
        : e instanceof ArrayBuffer || ArrayBuffer.isView(e)
        ? { i: n, o: BigInt(e.byteLength), u: s }
        : { i: n, o: vi(e, i), u: s }
    );
  }
  function vi(e, t) {
  ...
  function bi(e, t = 1) {
    ...
    if (t) for (; 47 === e[e.length - 1]; ) e = e.subarray(0, -1);
    else 47 !== e[e.length - 1] && (e = new Uint8Array([...e, 47]));
    return e;
  }
  var wi = new Uint32Array(256);
  for (let e = 0; e < 256; ++e) {
    let t = e;
    for (let e = 0; e < 8; ++e) t = (t >>> 1) ^ (1 & t && 3988292384);
    wi[e] = t;
  }
  function yi(e, t = 0) {
    t = ~t;
  ...
  function Ai(e, t, i = 0) {
    ...
    t.setUint16(i, n, 1), t.setUint16(i + 2, s, 1);
  }
  function xi({ i: e, u: t }, i) {
    return (
      8 *
      (!t ||
        (i ??
  ...
  var Ci = new TextDecoder('utf8', { fatal: 1 });
  function ki(e, t = 0) {
    const i = hi(30);
    return (
      i.setUint32(0, 1347093252),
      i.setUint32(4, 754976768 | t),
      Ai(e.t, i, 10),
      i.setUint16(26, e.i.length, 1),
      ci(i)
    );
  }
  async function* Si(e) {
    ...
    if (('then' in t && (t = await t), t instanceof Uint8Array))
      yield t, (e.l = yi(t, 0)), (e.o = BigInt(t.length));
    else {
      e.o = 0n;
      const i = t.getReader();
      for (;;) {
        const { value: t, done: n } = await i.read();
        if (n) break;
        (e.l = yi(t, e.l)), (e.o += BigInt(t.length)), yield t;
      }
    }
  }
  function zi(e, t) {
    const i = hi(16 + (t ? 8 : 0));
    return (
      i.setUint32(0, 1347094280),
      i.setUint32(4, e.isFile ? e.l : 0, 1),
      t
        ? (i.setBigUint64(8, e.o, 1), i.setBigUint64(16, e.o, 1))
        : (i.setUint32(8, pi(e.o), 1), i.setUint32(12, pi(e.o), 1)),
      ci(i)
    );
  }
  function Ei(e, t, i = 0, n = 0) {
    const s = hi(46);
    return (
      s.setUint32(0, 1347092738),
      s.setUint32(4, 755182848),
      s.setUint16(8, 2048 | i),
      Ai(e.t, s, 12),
      s.setUint32(16, e.isFile ? e.l : 0, 1),
      s.setUint32(20, pi(e.o), 1),
      s.setUint32(24, pi(e.o), 1),
      s.setUint16(28, e.i.length, 1),
      s.setUint16(30, n, 1),
      s.setUint16(40, e.mode | (e.isFile ? 32768 : 16384), 1),
      s.setUint32(42, pi(t), 1),
      ci(s)
    );
  }
  function Ii(e, t, i) {
    ...
    return (
      n.setUint16(0, 1, 1),
      n.setUint16(2, i - 4, 1),
      16 & i && (n.setBigUint64(4, e.o, 1), n.setBigUint64(12, e.o, 1)),
      n.setBigUint64(i - 8, t, 1),
      ci(n)
    );
  }
  function Pi(e) {
  ...
  var Mi = (e) =>
    (function (e) {
      let t = BigInt(22),
        ...
        n = 0;
      for (const s of e) {
        if (!s.i) throw new Error('Every file must have a non-empty name.');
        if (void 0 === s.o)
          throw new Error(
            `Missing size for file "${new TextDecoder().decode(s.i)}".`,
          );
        const e = s.o >= 0xffffffffn,
          o = i >= 0xffffffffn;
        (i += BigInt(46 + s.i.length + (e && 8)) + s.o),
          (t += BigInt(s.i.length + 46 + ((12 * o) | (28 * e)))),
          n || (n = e);
      }
      return (n || i >= 0xffffffffn) && (t += BigInt(76)), t + i;
    })(
      (function* (e) {
        for (const t of e) yield fi(...Pi(t)[0]);
      })(e),
    );
  function Li(e, t = {}) {
    const i = (function (e) {
      ...
      return {
        async next() {
          ...
          if (e.done) return e;
          const [i, n] = Pi(e.value);
          return { done: 0, value: Object.assign(gi(...n), fi(...i)) };
        },
        throw: t.throw?.bind(t),
    ...
    return mi(
      (async function* (e, t) {
        ...
        for await (const a of e) {
          const e = xi(a, t.buffersAreUTF8);
          yield ki(a, e), yield new Uint8Array(a.i), a.isFile && (yield* Si(a));
          const r = a.o >= 0xffffffffn,
            l = (12 * (n >= 0xffffffffn)) | (28 * r);
          yield zi(a, r),
            i.push(Ei(a, n, e, l)),
            i.push(a.i),
            l && i.push(Ii(a, n, l)),
            r && (n += 8n),
            s++,
            (n += BigInt(46 + a.i.length) + a.o),
            o || (o = r);
        }
        let a = 0n;
        for (const e of i) yield e, (a += BigInt(e.length));
        if (o || n >= 0xffffffffn) {
          const e = hi(76);
          e.setUint32(0, 1347094022),
            e.setBigUint64(4, BigInt(44), 1),
            e.setUint32(12, 755182848),
            e.setBigUint64(24, s, 1),
            e.setBigUint64(32, s, 1),
            e.setBigUint64(40, a, 1),
            e.setBigUint64(48, n, 1),
            e.setUint32(56, 1347094023),
            e.setBigUint64(64, n + a, 1),
            e.setUint32(72, 1, 1),
            yield ci(e);
        }
        const r = hi(22);
        r.setUint32(0, 1347093766),
          r.setUint16(8, ui(s), 1),
          r.setUint16(10, ui(s), 1),
          r.setUint32(12, pi(a), 1),
          r.setUint32(16, pi(n), 1),
          yield ci(r);
      })(i, t),
      i,
    );
      ...
      n = e.map((e) => {
        const n = (function (e, t) {
          ...
          (function (e, t) {
            ...
            return -1 === n ? e + i : e.slice(0, n) + i + e.slice(n);
          })(e.name, t),
          i,
        );
        return (
          i.add(n),
          { name: n, input: e, lastModified: new Date(e.lastModified) }
        );
      });
    return (function (e, t = {}) {
      const i = {
      ...
      return (
        ('bigint' == typeof t.length || Number.isInteger(t.length)) &&
          t.length > 0 &&
          (i['Content-Length'] = String(t.length)),
        t.metadata && (i['Content-Length'] = String(Mi(t.metadata))),
        new Response(Li(e, t), { headers: i })
      );
    })(n).blob();
  }
  function qi(e) {
  ...
  function Oi({ result: e }) {
    const t = Ri[e.status];
    if ('done' === e.status && void 0 !== e.outputSize) {
      const n = 1 - e.outputSize / e.file.size,
        s = Math.round(100 * n);
      return i.h(
        'span',
        { style: { color: t, whiteSpace: 'nowrap' } },
        qi(e.file.size),
        ' → ',
        qi(e.outputSize),
        ' ',
        i.h('strong', null, s >= 0 ? '−' : '+', Math.abs(s), '%'),
      );
    }
    const n =
      'queued' === e.status
    ...
    return i.h(
      ...
      {
        style: { color: t, whiteSpace: 'nowrap' },
        title: e.error ? e.error.message : void 0,
      },
      n,
    );
  }
  class Di extends i.d {
    render({
      results: e,
      running: t,
      suffix: n,
      ...
      const h = e.length,
        c = e.filter((e) => 'done' === e.status).length,
        d = e.filter(
          (e) => 'error' === e.status || 'cancelled' === e.status,
        ).length,
        p = h ? (c + d) / h : 0;
      return i.h(
        'div',
        ...
        i.h(
          ...
          i.h(
            'div',
            { style: { padding: '12px 16px', borderBottom: '1px solid #333' } },
            i.h(
              'div',
              {
                style: {
              ...
              t && i.h('span', { style: { color: '#999' } }, 'Working…'),
            ),
            i.h(
              'div',
              {
              ...
              i.h('div', {
                style: {
                  width: `${Math.round(100 * p)}%`,
                  height: '100%',
                  background: d > 0 ? '#ef9a9a' : '#66bb6a',
          ...
          i.h(
            ...
            t
              ? i.h('button', { type: 'button', onClick: o }, 'Cancel')
              : i.h(
                  i.p,
                  null,
                  i.h(
                  ...
                  i.h(
                    'button',
                    { type: 'button', onClick: r, disabled: 0 === c },
                    'Download .zip (',
                    c,
                    ')',
                  ),
  ...
  function Ti(e, t) {
    const i = new Map(t.map((e) => [e.file, e]));
    return e.map((e) => i.get(e.file) || e);
  }
  const Ui = document.title;
  function Fi(e) {
    const { loading: t, filename: i } = e;
    let n = '';
    t && (n += '⏳ '), i && (n += i + ' - '), (n += Ui), (document.title = n);
  }
  class Hi extends i.d {
    constructor(t) {
      super(t),
        ...
        (this.state = {
          ...
          sides: [
            localStorage.getItem('leftSideSettings')
              ...
              : {
                  latestSettings: { processorState: Ge, encoderState: void 0 },
                  loading: !1,
                },
            localStorage.getItem('rightSideSettings')
              ...
              : {
                  latestSettings: {
                    ...
                    encoderState: {
                      type: 'mozJPEG',
                      options: We.mozJPEG.meta.defaultOptions,
                    },
                  },
                  loading: !1,
                },
        ...
        (this.encodeCache = new Vt()),
        (this.workerBridges = [new $t(), new $t()]),
        ...
        (this.onEncoderTypeChange = (e, t) => {
          this.setState({
            sides: kt(
              this.state.sides,
              `${e}.latestSettings.encoderState`,
              'identity' === t
                ? void 0
                : { type: t, options: We[t].meta.defaultOptions },
            ),
          });
        }),
        (this.onProcessorOptionsChange = (e, t) => {
          this.setState({
            sides: kt(
              this.state.sides,
              `${e}.latestSettings.processorState`,
              t,
            ),
          });
        }),
        ...
        (this.onCopyToOtherClick = async (e) => {
          const t = e ? 0 : 1,
            ...
            n = { ...this.state.sides[e] };
          n.file && (n.downloadUrl = URL.createObjectURL(n.file)),
            this.setState({ sides: kt(this.state.sides, t, n) });
          'undo' ===
            (await this.props.showSnack('Settings copied across', {
              timeout: 5e3,
              actions: ['undo', 'dismiss'],
            })) && this.setState({ sides: kt(this.state.sides, t, i) });
        }),
        (this.onSaveSideSettingsClick = async (e) => {
          if (0 === e) {
            ...
            return (
              localStorage.setItem('leftSideSettings', t),
              window.dispatchEvent(new CustomEvent('leftSideSettings')),
              void (await this.props.showSnack('Left side settings saved', {
                timeout: 1500,
                actions: ['dismiss'],
              }))
            );
          ...
          if (1 === e) {
            ...
            return (
              localStorage.setItem('rightSideSettings', t),
              window.dispatchEvent(new CustomEvent('rightSideSettings')),
              void (await this.props.showSnack('Right side settings saved', {
                timeout: 1500,
                actions: ['dismiss'],
              }))
            );
        ...
        (this.onImportSideSettingsClick = async (e) => {
          ...
          if (0 === e && t) {
            const i = this.state.sides[e],
              n = { ...this.state.sides[e], ...JSON.parse(t) };
            this.setState({ sides: kt(this.state.sides, e, n) });
            'undo' ===
              (await this.props.showSnack('Left side settings imported', {
                timeout: 3e3,
                actions: ['undo', 'dismiss'],
              })) && this.setState({ sides: kt(this.state.sides, e, i) });
          } else if (1 === e && i) {
            const t = this.state.sides[e],
              n = { ...this.state.sides[e], ...JSON.parse(i) };
            this.setState({ sides: kt(this.state.sides, e, n) });
            'undo' ===
              (await this.props.showSnack('Right side settings imported', {
                timeout: 3e3,
                actions: ['undo', 'dismiss'],
              })) && this.setState({ sides: kt(this.state.sides, e, t) });
          } else;
        }),
        (this.onPreprocessorChange = async (e) => {
          if (!this.state.source) return;
          const t =
            this.state.preprocessorState.rotate.rotate % 180 !=
            e.rotate.rotate % 180;
          this.setState((i) => ({
            loading: !0,
            preprocessorState: e,
            sides: t
              ? i.sides.map((e) => {
                  ...
                  return Ct(e, 'latestSettings.processorState.resize', {
                    width: t.height,
                    height: t.width,
                  });
                })
        ...
        (this.onCompressAll = async () => {
          if (this.state.batchRunning) return;
          const e = this.batchSettings();
          e
            ? (this.setState({ batchOpen: !0 }),
              await this.runBatch(this.props.files, e, !1))
        ...
        (this.onBatchCancel = () => {
          var e;
          null === (e = this.batchRunner) || void 0 === e || e.cancel();
        }),
        (this.onBatchClose = () => {
          var e;
          this.state.batchRunning &&
            (null === (e = this.batchRunner) || void 0 === e || e.cancel()),
            this.setState({ batchOpen: !1 });
        }),
        (this.onBatchRetry = async () => {
          if (this.state.batchRunning) return;
          const e = this.batchSettings();
          if (!e) return;
          const t = this.state.batchResults
            .filter((e) => 'error' === e.status || 'cancelled' === e.status)
            .map((e) => e.file);
          0 !== t.length && (await this.runBatch(t, e, !0));
        }),
        (this.onBatchSuffixChange = (e) => {
          this.setState({ batchSuffix: e });
        }),
        (this.onBatchDownloadZip = async () => {
          const e = this.state.batchResults
            .filter((e) => 'done' === e.status && e.result)
            .map((e) => e.result);
          if (0 !== e.length)
            try {
              !(function (e, t) {
              ...
              })(await Bi(e, this.state.batchSuffix), 'squoosh.zip');
            } catch (e) {
              this.props.showSnack(`Couldn't create zip: ${e}`);
            }
        }),
        (this.activeSideJobs = [void 0, void 0]),
        this.widthQuery.addListener(this.onMobileWidthChange),
        (this.sourceFile = t.file),
        this.queueUpdateImage({ immediate: !0 }),
        e('./sw-bridge-6c37044f').then(({ mainAppLoaded: e }) => e());
    }
    componentWillReceiveProps(e) {
      e.file !== this.props.file &&
        ((this.sourceFile = e.file),
        this.state.preprocessorState.crop.enabled &&
          this.setState((e) => ({
            preprocessorState: kt(e.preprocessorState, 'crop', Xe.crop),
          })),
        this.queueUpdateImage({ immediate: !0 }));
    }
    componentWillUnmount() {
    ...
    componentDidUpdate(e, t) {
      ...
      (n !== s || o) &&
        Fi({
          loading: s,
          filename:
            null === (i = this.state.source) || void 0 === i
              ? void 0
              : i.file.name,
        }),
        this.queueUpdateImage();
    }
    queueUpdateImage({ immediate: e } = {}) {
    ...
    batchSettings() {
      const e = this.state.sides.find((e) => e.latestSettings.encoderState);
      return e && e.latestSettings.encoderState
        ? {
    ...
    async runBatch(e, t, i) {
      ...
      (this.batchRunner = n),
        this.setState((t) => ({
          ...
          batchResults: i
            ? t.batchResults
            : e.map((e) => ({ file: e, status: 'queued' })),
        }));
      try {
        await n.run(e, t, (e) => {
          this.setState((t) => ({
            batchResults: i ? Ti(t.batchResults, e) : e,
          }));
        });
      } finally {
        n.dispose(),
          (this.batchRunner = void 0),
          this.setState({ batchRunning: !1 });
      }
    }
    async updateImage() {
      const e = this.state,
        ...
        i = e.sides.map(
          (e, t) =>
            this.activeSideJobs[t] || {
              processorState:
                e.encodedSettings && e.encodedSettings.processorState,
              encoderState: e.encodedSettings && e.encodedSettings.encoderState,
            },
        ),
        n = { file: this.sourceFile, preprocessorState: e.preprocessorState },
        s = e.sides.map((e) => ({
          processorState: e.latestSettings.encoderState
            ? e.latestSettings.processorState
            : Ge,
          encoderState: e.latestSettings.encoderState,
        })),
        ...
        r = i.map((e, t) => {
          const i =
            a ||
            !e.processorState ||
            !!e.encoderState != !!s[t].encoderState ||
            !(function (e, t) {
              if (e === t) return !0;
      ...
      (o || a) &&
        ...
        (this.mainAbortController = new AbortController()),
        (h = !0),
        (this.activeMainJob = n));
      for (const [e, t] of r.entries())
        (t.processing || t.encoding) &&
          (this.sideAbortControllers[e].abort(),
          (this.sideAbortControllers[e] = new AbortController()),
          (h = !0),
          (this.activeSideJobs[e] = s[e]));
      if (!h) return;
      const c = this.mainAbortController.signal,
        d = this.sideAbortControllers.map((e) => e.signal);
      let p, u, g;
      if (o)
        try {
          y(c),
            this.setState({ source: void 0, loading: !0 }),
            n.file.type.startsWith('image/svg+xml')
              ? ((u = await si(c, n.file)), (p = l(u)))
              : (p = await ei(c, n.file, this.workerBridges[0])),
            this.setState((e) => {
              if (c.aborted) return {};
              return {
                sides: e.sides.map((e) =>
                  Ct(e, 'latestSettings.processorState.resize', {
                    width: p.width,
                    height: p.height,
      ...
      else ({ decoded: p, vectorImage: u } = e.source);
      if (a)
        try {
          y(c), this.setState({ loading: !0 });
          const e = await ti(c, p, n.preprocessorState, this.workerBridges[0]);
          (g = { decoded: p, vectorImage: u, preprocessed: e, file: n.file }),
            this.setState((t) => {
              if (c.aborted) return {};
              let i = {
                ...t,
          ...
          throw (
            ...
            this.props.showSnack(`Preprocessing error: ${e}`),
            e)
          );
        }
      else g = e.source;
      (this.activeMainJob = void 0),
        r.forEach(async (t, i) => {
          try {
            ...
            let r, l, h;
            if (o.encoderState) {
              const s = this.encodeCache.match(
                g.preprocessed,
                o.processorState,
                o.encoderState,
              );
              s
                ? ({ file: r, processed: h, data: l } = s)
                : (this.setState((e) => {
                    if (n.aborted) return {};
                    return { sides: Ct(e.sides, i, { loading: !0 }) };
                  }),
                  t.processing
                    ? ((h = await ii(n, g, o.processorState, a)),
                      this.setState((e) => {
                        if (n.aborted) return {};
                        const t = e.sides[i],
                          s = {
                        ...
                        return { sides: kt(e.sides, i, s) };
                      }))
                    : (h = e.sides[i].processed),
                  (r = await ni(n, h, o.encoderState, g.file.name, a)),
                  (l = await ei(n, r, a)),
                  this.encodeCache.add({
                    data: l,
                    processed: h,
                    file: r,
                    preprocessed: g.preprocessed,
                    encoderState: o.encoderState,
                    processorState: o.processorState,
                  }));
            } else (r = g.file), (l = g.preprocessed);
            this.setState((e) => {
              if (n.aborted) return {};
              const t = e.sides[i];
              t.downloadUrl && URL.revokeObjectURL(t.downloadUrl);
            ...
            throw (
              (this.setState((e) => ({
                sides: Ct(e.sides, i, { loading: !1 }),
              })),
              this.props.showSnack(`Processing error: ${e}`),
              e)
            );
          }
        });
      ...
      const [u, g] = n,
        ...
        v = n.map((e, n) =>
          i.h(Zt, {
            ...
            loading: t || e.loading,
            flipSide: r || 1 === n,
            typeLabel: e.latestSettings.encoderState
              ? We[e.latestSettings.encoderState.type].meta.label
              : '' + (e.file ? `${e.file.name}` : 'Original Image'),
          }),
        ),
        b = u.encodedSettings || u.latestSettings,
        w = g.encodedSettings || g.latestSettings,
        y =
          b.processorState.resize.enabled &&
          'contain' === b.processorState.resize.fitMethod,
        A =
          w.processorState.resize.enabled &&
          'contain' === w.processorState.resize.fitMethod;
      return i.h(
        'div',
        { class: '_compress_k3l4d_1' },
        i.h(Lt, {
          source: a,
          mobileView: r,
          leftCompressed: m,
        ...
        i.h(
          'button',
          { class: '_back_k3l4d_106 unbutton', onClick: e },
          i.h(
            'svg',
            { viewBox: '0 0 61 53.3' },
            i.h('title', null, 'Back'),
            i.h('path', {
              class: '_back-blob_k3l4d_119',
        ...
        r
          ? i.h(
              'div',
              { class: '_options_k3l4d_22' },
              i.h(
                'multi-panel',
                { class: '_multi-panel_k3l4d_81', 'open-one-only': !0 },
                i.h('div', { class: s }, v[0]),
                i.h('div', { class: s }, f[0]),
                i.h('div', { class: o }, v[1]),
                i.h('div', { class: o }, f[1]),
          ...
          : [
              i.h(
                ...
                {
                  class:
                    '_options-1_k3l4d_43 _options_k3l4d_22 _options-1-theme_k3l4d_43',
                  key: 'options1',
                },
                f[0],
                v[0],
              ...
              i.h(
                ...
                {
                  class:
                    '_options-2_k3l4d_56 _options_k3l4d_22 _options-2-theme_k3l4d_56',
                  key: 'options2',
                },
                f[1],
                v[1],

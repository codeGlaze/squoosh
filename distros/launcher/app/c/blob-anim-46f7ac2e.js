define(['exports', './initial-app-6fa33816'], function (t, e) {
  const a = 0.25;
  function o(t) {
      ...
      this.points = this.animStates.map((e) => {
        (e.pos += t / e.duration),
          e.pos >= 1 &&
            ...
            (e.pos = 0),
            (e.duration = n(this.minDuration, this.maxDuration)),
            (e.endPoint = o(e.basePoint)));
        const a = i(e.pos);
  ...
  class h {
    constructor() {
      (this.rotatePos = 0),
        (this.blobs = Array.from(
          { length: 4 },
          (t, a) => new r(s, { startPoints: e.startBlobs[a] }),
        ));
    }
    advance(t) {
    ...
    draw(t, e, a, o) {
      t.save(),
        t.translate(e, a),
        t.scale(o, o),
        t.rotate(2 * Math.PI * this.rotatePos);
  ...
  class c {
    constructor(t) {
      ...
      this.bgBlobs = Array.from({ length: e }, () => {
        const e = 0 === (a = Math.random()) ? 0 : Math.pow(2, 10 * a - 10);
        var a;
        return {
          blob: new r(s, { minDuration: 2e3, maxDuration: 5e3 }),
          velocity: 0.0055 * (1 - e) + l,
    ...
    advance(t, e, a, o, i) {
      1 !== this.overallAlphaPos &&
        (this.overallAlphaPos = Math.min(1, this.overallAlphaPos + t / 2e3));
      for (const n of this.bgBlobs) {
        n.blob.advance(t);
        let s = Math.hypot(n.x - a, n.y - o);
        if (((n.rotatePos = (n.rotatePos + t / n.spinTime) % 1), s < 10))
          switch (Math.floor(4 * Math.random())) {
            ...
            case 1:
              ...
              break;
            case 2:
              (n.x = Math.random() * e.width),
                (n.y = e.height + 1.25 * n.radius);
              break;
            case 3:
              (n.x = e.width + 1.25 * n.radius),
                (n.y = Math.random() * e.height);
          }
        s = Math.hypot(n.x - a, n.y - o);
        const r =
            (s > 300 ? n.velocity : (14 * (1 - s / 300) + 1) * n.velocity) * t,
    ...
    draw(t) {
      ...
      for (const a of this.bgBlobs)
        t.save(),
          (t.globalAlpha = a.alpha * a.alphaMultiplier * e),
          t.translate(a.x, a.y),
          t.scale(a.radius, a.radius),
          t.rotate(2 * Math.PI * a.rotatePos),
          a.blob.draw(t),
          t.restore();
    }
  }
  t.startBlobAnim = function (t) {
    ...
    function v(e) {
      ...
      (t.width = a.width * devicePixelRatio),
        (t.height = a.height * devicePixelRatio);
      const r = s.getBoundingClientRect(),
        ...
        m = r.height / 2 / 1.25;
      o.scale(devicePixelRatio, devicePixelRatio),
        n || (n = new c(a)),
        n.advance(e, a, d, u, m),
        i.advance(e),
        (o.globalAlpha = Number(h.getPropertyValue('--center-blob-opacity'))),
        (o.fillStyle = l),
        n.draw(o),
        i.draw(o, d, u, m);
    }
    function P(e) {
      if (!t.isConnected)
        return (
          removeEventListener('focus', m),
          removeEventListener('blur', b),
          p.disconnect(),
          void document.removeEventListener('visibilitychange', u)
        );
      if (r) 1 !== l && (l = Math.min(1, l + 0.01));
      else if (((l = Math.max(0, l - 0.01)), 0 === l)) return void (d = !1);
      const o = (e - a) * l;

define(['exports'], function (e) {
  ...
  function i(e, n = self) {
    n.addEventListener('message', function r(s) {
      if (!s || !s.data) return;
      const { id: o, type: u, path: l } = Object.assign({ path: [] }, s.data),
        p = (s.data.argumentList || []).map(d);
      let f;
      try {
      ...
      Promise.resolve(f)
        ...
        .then((e) => {
          const [t, a] = h(e);
          n.postMessage(Object.assign(Object.assign({}, t), { id: o }), a),
            5 === u && (n.removeEventListener('message', r), c(n));
        });
    }),
      n.start && n.start();
  }
  ...
  function p(e, t = [], a = function () {}) {
    ...
    const o = new Proxy(a, {
      get(n, a) {
        if ((l(s), a === r))
          return () =>
            g(e, { type: 5, path: t.map((e) => e.toString()) }).then(() => {
              c(e), (s = !0);
            });
        if ('then' === a) {
          if (0 === t.length) return { then: () => o };
          const n = g(e, { type: 0, path: t.map((e) => e.toString()) }).then(d);
      ...
      set(n, r, a) {
        ...
        return g(
          e,
          { type: 1, path: [...t, r].map((e) => e.toString()), value: o },
          i,
        ).then(d);
      },
      apply(r, a, o) {
        ...
        if (i === n) return g(e, { type: 4 }).then(d);
        if ('bind' === i) return p(e, t.slice(0, -1));
        const [c, u] = f(o);
        return g(
          e,
          { type: 2, path: t.map((e) => e.toString()), argumentList: c },
          u,
        ).then(d);
      },
      construct(n, r) {
  ...
  (e.expose = i),
    (e.getContainOffsets = function (e, t, n, r) {
      const a = n / r;
      if (a > e / t) {
        const n = e / a;

      ...
      function (r) {
        ...
        function I(n) {
          (g = n),
            ...
            (r.HEAPU16 = _ = new Uint16Array(n)),
            (r.HEAPU32 = E = new Uint32Array(n)),
            (r.HEAPF32 = F = new Float32Array(n)),
            (r.HEAPF64 = A = new Float64Array(n));
        }
        r.INITIAL_MEMORY;
        var x = [],
          D = [],
        ...
        if (r.locateFile)
          q((z = 'wp2_enc.wasm')) ||
            ((B = z), (z = r.locateFile ? r.locateFile(B, f) : f + B));
        else var z = new URL('/c/wp2_enc-89317929.wasm', n.uri).toString();
        function G(n) {
          try {
        ...
        function _n(n) {
          switch (n) {
            ...
            default:
              ...
              return (gn[r] = { refcount: 1, value: n }), r;
          }
        }
        function bn(n) {
        ...
        (un = r.InternalError = an(Error, 'InternalError')),
          ...
          (hn = r.BindingError = an(Error, 'BindingError')),
          (r.count_emval_handles = wn),
          (r.get_first_emval = Tn),
          (Rn = r.UnboundTypeError = an(Error, 'UnboundTypeError'));
        var Hn = {
          o: function (n, r, t, e) {
            M(
              'Assertion failed: ' +
                  ...
                  !(function (n, r) {
                    ...
                    throw (
                      (r.forEach(function n(r) {
                        e[r] ||
                          Q[r] ||
                          (nn[r] ? nn[r].forEach(n) : (t.push(r), (e[r] = !0)));
                      }),
            ...
            dn(n, {
              ...
              fromWireType: function (n) {
                ...
                if (t)
                  ...
                  var c = new Array(e);
                  for (i = 0; i < e; ++i)
                    c[i] = String.fromCharCode(w[n + 4 + i]);
                  r = c.join('');
                }
                return Nn(n), r;
              },
              toWireType: function (n, r) {
                ...
                else for (u = 0; u < i; ++u) w[a + 4 + u] = r[u];
          ...
          A: function (n) {
            return 0 === n
              ? _n(kn())
              : ((n = void 0 === (t = Wn[(r = n)]) ? pn(r) : t), _n(kn()[n]));
            var r, t;
          },
          j: function (n) {
            n > 4 && (gn[n].refcount += 1);
          ...
          n: function (n, t, e, o) {
            n = (function (n) {
              return (
                n || vn('Cannot use deleted val. handle = ' + n), gn[n].value
              );
            })(n);
            var i = In[t];
            return (
          ...
          d: function (n) {
            ...
            for (var i = 1; i <= 4; i *= 2) {
              var a = e * (1 + 0.2 / i);
              if (
                ((a = Math.min(a, n + 100663296)),
                xn(
                  Math.min(
                    o,
                    ((r = Math.max(n, a)) % (t = 65536) > 0 &&
                      (r += t - (r % t)),
                    r),
                  ),
                ))

const ASSETS = [
  ...
  'c/initial-app-6fa33816.js',
  'c/idb-keyval-70c4f780.js',
  'c/supports-wasm-threads-b0989f01.js',
  'c/features-worker-272a027f.js',
  'c/util-06ce6ead.js',
  'c/wp2_enc_mt.worker-23ef1dda.js',
  'c/wp2_enc_mt_simd.worker-21213cbe.js',
  'c/jxl_enc_mt_simd.worker-cb879517.js',
  'c/jxl_enc_mt.worker-b452e37b.js',
  'c/avif_enc_mt.worker-8987c56e.js',
  'c/workerHelpers-8abc84b0.js',
  'c/Compress-d6f5ed18.js',
  'c/sw-bridge-6c37044f.js',
  'c/blob-anim-46f7ac2e.js',
  'c/avif_dec-61445e6d.js',
  'c/webp_dec-318dc2b4.js',
  'c/avif_enc_mt-8ae87cf4.js',
  'c/avif_enc-04767266.js',
  'c/jxl_enc_mt_simd-71ffab59.js',
  'c/jxl_enc_mt-4e19ab9c.js',
  'c/jxl_enc-fe8a44c4.js',
  'c/squoosh_oxipng-f859751f.js',
...
const VERSION = 'd91674916654f3d87e0e98fcd1530cad39fe90d0';
if (!self.define) {
  let e = {};
  const A = (A, t) => (
...
define([
  './c/supports-wasm-threads-b0989f01',
  './c/idb-keyval-70c4f780',
], function (e, A) {
  var t =
  ...
  const a = '/c/initial-app-6fa33816.js',
    _ = [
      '/c/logo-bcc20dd5.svg',
      '/c/github-logo-bc05494c.svg',
      '/c/demo-large-photo-a6b23f7b.jpg',
    ...
    r = '/c/sw-bridge-6c37044f.js',
    c = ['/c/idb-keyval-70c4f780.js', '/serviceworker.js'],
    o = '/c/blob-anim-46f7ac2e.js',
    l = [
      '/c/initial-app-6fa33816.js',
      '/c/logo-bcc20dd5.svg',
      '/c/github-logo-bc05494c.svg',
    ...
    N = '/c/features-worker-272a027f.js',
    E = [
      '/c/util-06ce6ead.js',
      '/c/supports-wasm-threads-b0989f01.js',
      '/c/jxl_dec-e90a5afa.wasm',
  ...
  const f = '/c/avif_dec-61445e6d.js',
    u = ['/c/avif_dec-d634d9c0.wasm'];
  var p = Object.freeze({ __proto__: null, main: f, deps: u });
  const T = '/c/webp_dec-318dc2b4.js',
    m = ['/c/webp_dec-12bed04a.wasm'];
  var P = Object.freeze({ __proto__: null, main: T, deps: m });
  const D = '/c/avif_enc_mt-8ae87cf4.js',
    I = ['/c/avif_enc_mt-9d34100e.wasm', '/c/avif_enc_mt.worker-8987c56e.js'];
  var h = Object.freeze({ __proto__: null, main: D, deps: I });
  const U = '/c/avif_enc-04767266.js',
    w = ['/c/avif_enc-90ce2a03.wasm'];
  var G = Object.freeze({ __proto__: null, main: U, deps: w });
  const R = '/c/jxl_enc_mt_simd-71ffab59.js',
    L = [
      '/c/jxl_enc_mt_simd-efe18ebf.wasm',
      '/c/jxl_enc_mt_simd.worker-cb879517.js',
    ];
  var Y = Object.freeze({ __proto__: null, main: R, deps: L });
  const M = '/c/jxl_enc_mt-4e19ab9c.js',
    S = ['/c/jxl_enc_mt-669d03c7.wasm', '/c/jxl_enc_mt.worker-b452e37b.js'];
  ...
  const j = '/c/squoosh_oxipng-f859751f.js',
    y = ['/c/workerHelpers-8abc84b0.js', '/c/squoosh_oxipng_bg-5c8fadb7.wasm'];
  var O = Object.freeze({ __proto__: null, main: j, deps: y });
  const z = '/c/squoosh_oxipng-78efb8fb.js',
    W = ['/c/squoosh_oxipng_bg-60d7d0b0.wasm'];
  ...
  const F = '/c/wp2_enc_mt_simd-5587fe8b.js',
    K = [
      '/c/wp2_enc_mt_simd-0b0595e9.wasm',
      '/c/wp2_enc_mt_simd.worker-21213cbe.js',
    ];
  var V = Object.freeze({ __proto__: null, main: F, deps: K });
  const H = '/c/wp2_enc_mt-9627618e.js',
    J = ['/c/wp2_enc_mt-1feb6658.wasm', '/c/wp2_enc_mt.worker-23ef1dda.js'];
